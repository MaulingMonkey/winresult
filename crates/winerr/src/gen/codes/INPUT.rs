...
pub const E_OUT_OF_ORDER : HRESULT = HRESULT::from_constant(0x80400000); // INPUT_E_OUT_OF_ORDER

/// Requested operation cannot be performed inside the callback or event handler.
pub const E_REENTRANCY : HRESULT = HRESULT::from_constant(0x80400001); // INPUT_E_REENTRANCY

/// Input cannot be processed because there is ongoing interaction with another pointer type.
pub const E_MULTIMODAL : HRESULT = HRESULT::from_constant(0x80400002); // INPUT_E_MULTIMODAL

/// One or more fields in the input packet are invalid.
pub const E_PACKET : HRESULT = HRESULT::from_constant(0x80400003); // INPUT_E_PACKET
...
pub const E_FRAME : HRESULT = HRESULT::from_constant(0x80400004); // INPUT_E_FRAME
...
pub const E_HISTORY : HRESULT = HRESULT::from_constant(0x80400005); // INPUT_E_HISTORY

/// Failed to retrieve information about the input device.
pub const E_DEVICE_INFO : HRESULT = HRESULT::from_constant(0x80400006); // INPUT_E_DEVICE_INFO

/// Coordinate system transformation failed to transform the data.
pub const E_TRANSFORM : HRESULT = HRESULT::from_constant(0x80400007); // INPUT_E_TRANSFORM

/// The property is not supported or not reported correctly by the input device.
pub const E_DEVICE_PROPERTY : HRESULT = HRESULT::from_constant(0x80400008); // INPUT_E_DEVICE_PROPERTY
