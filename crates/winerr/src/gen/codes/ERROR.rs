...
pub const AUDITING_DISABLED : HRESULT = HRESULT::from_constant(0xC0090001); // ERROR_AUDITING_DISABLED

/// The SID filtering operation removed all SIDs.
pub const ALL_SIDS_FILTERED : HRESULT = HRESULT::from_constant(0xC0090002); // ERROR_ALL_SIDS_FILTERED

/// Business rule scripts are disabled for the calling application.
pub const BIZRULES_NOT_ENABLED : HRESULT = HRESULT::from_constant(0xC0090003); // ERROR_BIZRULES_NOT_ENABLED

/// The requested credential requires confirmation.
pub const CRED_REQUIRES_CONFIRMATION : HRESULT = HRESULT::from_constant(0x80097019); // ERROR_CRED_REQUIRES_CONFIRMATION

/// The IO was completed by a filter.
pub const FLT_IO_COMPLETE : HRESULT = HRESULT::from_constant(0x001F0001); // ERROR_FLT_IO_COMPLETE

/// A handler was not defined by the filter for this operation.
pub const FLT_NO_HANDLER_DEFINED : HRESULT = HRESULT::from_constant(0x801F0001); // ERROR_FLT_NO_HANDLER_DEFINED

/// A context is already defined for this object.
pub const FLT_CONTEXT_ALREADY_DEFINED : HRESULT = HRESULT::from_constant(0x801F0002); // ERROR_FLT_CONTEXT_ALREADY_DEFINED

/// Asynchronous requests are not valid for this operation.
pub const FLT_INVALID_ASYNCHRONOUS_REQUEST : HRESULT = HRESULT::from_constant(0x801F0003); // ERROR_FLT_INVALID_ASYNCHRONOUS_REQUEST

/// Disallow the Fast IO path for this operation.
pub const FLT_DISALLOW_FAST_IO : HRESULT = HRESULT::from_constant(0x801F0004); // ERROR_FLT_DISALLOW_FAST_IO

/// An invalid name request was made. The name requested cannot be retrieved at this time.
pub const FLT_INVALID_NAME_REQUEST : HRESULT = HRESULT::from_constant(0x801F0005); // ERROR_FLT_INVALID_NAME_REQUEST

/// Posting this operation to a worker thread for further processing is not safe at this time because it could lead to a system deadlock.
pub const FLT_NOT_SAFE_TO_POST_OPERATION : HRESULT = HRESULT::from_constant(0x801F0006); // ERROR_FLT_NOT_SAFE_TO_POST_OPERATION

/// The Filter Manager was not initialized when a filter tried to register. Make sure that the Filter Manager is getting loaded as a driver.
pub const FLT_NOT_INITIALIZED : HRESULT = HRESULT::from_constant(0x801F0007); // ERROR_FLT_NOT_INITIALIZED

/// The filter is not ready for attachment to volumes because it has not finished initializing (FltStartFiltering has not been called).
pub const FLT_FILTER_NOT_READY : HRESULT = HRESULT::from_constant(0x801F0008); // ERROR_FLT_FILTER_NOT_READY

/// The filter must cleanup any operation specific context at this time because it is being removed from the system before the operation is completed by the lower drivers.
pub const FLT_POST_OPERATION_CLEANUP : HRESULT = HRESULT::from_constant(0x801F0009); // ERROR_FLT_POST_OPERATION_CLEANUP

/// The Filter Manager had an internal error from which it cannot recover, therefore the operation has been failed. This is usually the result of a filter returning an invalid value from a pre-operation callback.
pub const FLT_INTERNAL_ERROR : HRESULT = HRESULT::from_constant(0x801F000A); // ERROR_FLT_INTERNAL_ERROR

/// The object specified for this action is in the process of being deleted, therefore the action requested cannot be completed at this time.
pub const FLT_DELETING_OBJECT : HRESULT = HRESULT::from_constant(0x801F000B); // ERROR_FLT_DELETING_OBJECT

/// Non-paged pool must be used for this type of context.
pub const FLT_MUST_BE_NONPAGED_POOL : HRESULT = HRESULT::from_constant(0x801F000C); // ERROR_FLT_MUST_BE_NONPAGED_POOL

/// A duplicate handler definition has been provided for an operation.
pub const FLT_DUPLICATE_ENTRY : HRESULT = HRESULT::from_constant(0x801F000D); // ERROR_FLT_DUPLICATE_ENTRY

/// The callback data queue has been disabled.
pub const FLT_CBDQ_DISABLED : HRESULT = HRESULT::from_constant(0x801F000E); // ERROR_FLT_CBDQ_DISABLED

/// Do not attach the filter to the volume at this time.
pub const FLT_DO_NOT_ATTACH : HRESULT = HRESULT::from_constant(0x801F000F); // ERROR_FLT_DO_NOT_ATTACH

/// Do not detach the filter from the volume at this time.
pub const FLT_DO_NOT_DETACH : HRESULT = HRESULT::from_constant(0x801F0010); // ERROR_FLT_DO_NOT_DETACH

/// An instance already exists at this altitude on the volume specified.
pub const FLT_INSTANCE_ALTITUDE_COLLISION : HRESULT = HRESULT::from_constant(0x801F0011); // ERROR_FLT_INSTANCE_ALTITUDE_COLLISION

/// An instance already exists with this name on the volume specified.
pub const FLT_INSTANCE_NAME_COLLISION : HRESULT = HRESULT::from_constant(0x801F0012); // ERROR_FLT_INSTANCE_NAME_COLLISION

/// The system could not find the filter specified.
pub const FLT_FILTER_NOT_FOUND : HRESULT = HRESULT::from_constant(0x801F0013); // ERROR_FLT_FILTER_NOT_FOUND

/// The system could not find the volume specified.
pub const FLT_VOLUME_NOT_FOUND : HRESULT = HRESULT::from_constant(0x801F0014); // ERROR_FLT_VOLUME_NOT_FOUND

/// The system could not find the instance specified.
pub const FLT_INSTANCE_NOT_FOUND : HRESULT = HRESULT::from_constant(0x801F0015); // ERROR_FLT_INSTANCE_NOT_FOUND

/// No registered context allocation definition was found for the given request.
pub const FLT_CONTEXT_ALLOCATION_NOT_FOUND : HRESULT = HRESULT::from_constant(0x801F0016); // ERROR_FLT_CONTEXT_ALLOCATION_NOT_FOUND

/// An invalid parameter was specified during context registration.
pub const FLT_INVALID_CONTEXT_REGISTRATION : HRESULT = HRESULT::from_constant(0x801F0017); // ERROR_FLT_INVALID_CONTEXT_REGISTRATION

/// The name requested was not found in Filter Manager's name cache and could not be retrieved from the file system.
pub const FLT_NAME_CACHE_MISS : HRESULT = HRESULT::from_constant(0x801F0018); // ERROR_FLT_NAME_CACHE_MISS

/// The requested device object does not exist for the given volume.
pub const FLT_NO_DEVICE_OBJECT : HRESULT = HRESULT::from_constant(0x801F0019); // ERROR_FLT_NO_DEVICE_OBJECT

/// The specified volume is already mounted.
pub const FLT_VOLUME_ALREADY_MOUNTED : HRESULT = HRESULT::from_constant(0x801F001A); // ERROR_FLT_VOLUME_ALREADY_MOUNTED

/// The specified Transaction Context is already enlisted in a transaction
pub const FLT_ALREADY_ENLISTED : HRESULT = HRESULT::from_constant(0x801F001B); // ERROR_FLT_ALREADY_ENLISTED

/// The specified context is already attached to another object
pub const FLT_CONTEXT_ALREADY_LINKED : HRESULT = HRESULT::from_constant(0x801F001C); // ERROR_FLT_CONTEXT_ALREADY_LINKED

/// No waiter is present for the filter's reply to this message.
pub const FLT_NO_WAITER_FOR_REPLY : HRESULT = HRESULT::from_constant(0x801F0020); // ERROR_FLT_NO_WAITER_FOR_REPLY

/// The filesystem database resource is in use. Registration cannot complete at this time.
pub const FLT_REGISTRATION_BUSY : HRESULT = HRESULT::from_constant(0x801F0023); // ERROR_FLT_REGISTRATION_BUSY
...
pub const HUNG_DISPLAY_DRIVER_THREAD : HRESULT = HRESULT::from_constant(0x80260001); // ERROR_HUNG_DISPLAY_DRIVER_THREAD

/// Monitor descriptor could not be obtained.
pub const MONITOR_NO_DESCRIPTOR : HRESULT = HRESULT::from_constant(0x00261001); // ERROR_MONITOR_NO_DESCRIPTOR

/// Format of the obtained monitor descriptor is not supported by this release.
pub const MONITOR_UNKNOWN_DESCRIPTOR_FORMAT : HRESULT = HRESULT::from_constant(0x00261002); // ERROR_MONITOR_UNKNOWN_DESCRIPTOR_FORMAT

/// Checksum of the obtained monitor descriptor is invalid.
pub const MONITOR_INVALID_DESCRIPTOR_CHECKSUM : HRESULT = HRESULT::from_constant(0xC0261003); // ERROR_MONITOR_INVALID_DESCRIPTOR_CHECKSUM

/// Monitor descriptor contains an invalid standard timing block.
pub const MONITOR_INVALID_STANDARD_TIMING_BLOCK : HRESULT = HRESULT::from_constant(0xC0261004); // ERROR_MONITOR_INVALID_STANDARD_TIMING_BLOCK

/// WMI data block registration failed for one of the MSMonitorClass WMI subclasses.
pub const MONITOR_WMI_DATABLOCK_REGISTRATION_FAILED : HRESULT = HRESULT::from_constant(0xC0261005); // ERROR_MONITOR_WMI_DATABLOCK_REGISTRATION_FAILED

/// Provided monitor descriptor block is either corrupted or does not contain monitor's detailed serial number.
pub const MONITOR_INVALID_SERIAL_NUMBER_MONDSC_BLOCK : HRESULT = HRESULT::from_constant(0xC0261006); // ERROR_MONITOR_INVALID_SERIAL_NUMBER_MONDSC_BLOCK

/// Provided monitor descriptor block is either corrupted or does not contain monitor's user friendly name.
pub const MONITOR_INVALID_USER_FRIENDLY_MONDSC_BLOCK : HRESULT = HRESULT::from_constant(0xC0261007); // ERROR_MONITOR_INVALID_USER_FRIENDLY_MONDSC_BLOCK

/// There is no monitor descriptor data at the specified (offset, size) region.
pub const MONITOR_NO_MORE_DESCRIPTOR_DATA : HRESULT = HRESULT::from_constant(0xC0261008); // ERROR_MONITOR_NO_MORE_DESCRIPTOR_DATA

/// Monitor descriptor contains an invalid detailed timing block.
pub const MONITOR_INVALID_DETAILED_TIMING_BLOCK : HRESULT = HRESULT::from_constant(0xC0261009); // ERROR_MONITOR_INVALID_DETAILED_TIMING_BLOCK

/// Monitor descriptor contains invalid manufacture date.
pub const MONITOR_INVALID_MANUFACTURE_DATE : HRESULT = HRESULT::from_constant(0xC026100A); // ERROR_MONITOR_INVALID_MANUFACTURE_DATE

#[doc(hidden)] pub const GRAPHICS_NOT_EXCLUSIVE_MODE_OWNER : HRESULT = HRESULT::from_constant(0xC0262000); // ERROR_GRAPHICS_NOT_EXCLUSIVE_MODE_OWNER
#[doc(hidden)] pub const GRAPHICS_INSUFFICIENT_DMA_BUFFER : HRESULT = HRESULT::from_constant(0xC0262001); // ERROR_GRAPHICS_INSUFFICIENT_DMA_BUFFER
#[doc(hidden)] pub const GRAPHICS_INVALID_DISPLAY_ADAPTER : HRESULT = HRESULT::from_constant(0xC0262002); // ERROR_GRAPHICS_INVALID_DISPLAY_ADAPTER
#[doc(hidden)] pub const GRAPHICS_ADAPTER_WAS_RESET : HRESULT = HRESULT::from_constant(0xC0262003); // ERROR_GRAPHICS_ADAPTER_WAS_RESET
#[doc(hidden)] pub const GRAPHICS_INVALID_DRIVER_MODEL : HRESULT = HRESULT::from_constant(0xC0262004); // ERROR_GRAPHICS_INVALID_DRIVER_MODEL
#[doc(hidden)] pub const GRAPHICS_PRESENT_MODE_CHANGED : HRESULT = HRESULT::from_constant(0xC0262005); // ERROR_GRAPHICS_PRESENT_MODE_CHANGED
#[doc(hidden)] pub const GRAPHICS_PRESENT_OCCLUDED : HRESULT = HRESULT::from_constant(0xC0262006); // ERROR_GRAPHICS_PRESENT_OCCLUDED
#[doc(hidden)] pub const GRAPHICS_PRESENT_DENIED : HRESULT = HRESULT::from_constant(0xC0262007); // ERROR_GRAPHICS_PRESENT_DENIED
#[doc(hidden)] pub const GRAPHICS_CANNOTCOLORCONVERT : HRESULT = HRESULT::from_constant(0xC0262008); // ERROR_GRAPHICS_CANNOTCOLORCONVERT
#[doc(hidden)] pub const GRAPHICS_DRIVER_MISMATCH : HRESULT = HRESULT::from_constant(0xC0262009); // ERROR_GRAPHICS_DRIVER_MISMATCH
#[doc(hidden)] pub const GRAPHICS_PARTIAL_DATA_POPULATED : HRESULT = HRESULT::from_constant(0x4026200A); // ERROR_GRAPHICS_PARTIAL_DATA_POPULATED
#[doc(hidden)] pub const GRAPHICS_PRESENT_REDIRECTION_DISABLED : HRESULT = HRESULT::from_constant(0xC026200B); // ERROR_GRAPHICS_PRESENT_REDIRECTION_DISABLED
#[doc(hidden)] pub const GRAPHICS_PRESENT_UNOCCLUDED : HRESULT = HRESULT::from_constant(0xC026200C); // ERROR_GRAPHICS_PRESENT_UNOCCLUDED
#[doc(hidden)] pub const GRAPHICS_WINDOWDC_NOT_AVAILABLE : HRESULT = HRESULT::from_constant(0xC026200D); // ERROR_GRAPHICS_WINDOWDC_NOT_AVAILABLE
#[doc(hidden)] pub const GRAPHICS_WINDOWLESS_PRESENT_DISABLED : HRESULT = HRESULT::from_constant(0xC026200E); // ERROR_GRAPHICS_WINDOWLESS_PRESENT_DISABLED
#[doc(hidden)] pub const GRAPHICS_PRESENT_INVALID_WINDOW : HRESULT = HRESULT::from_constant(0xC026200F); // ERROR_GRAPHICS_PRESENT_INVALID_WINDOW
#[doc(hidden)] pub const GRAPHICS_PRESENT_BUFFER_NOT_BOUND : HRESULT = HRESULT::from_constant(0xC0262010); // ERROR_GRAPHICS_PRESENT_BUFFER_NOT_BOUND
#[doc(hidden)] pub const GRAPHICS_VAIL_STATE_CHANGED : HRESULT = HRESULT::from_constant(0xC0262011); // ERROR_GRAPHICS_VAIL_STATE_CHANGED
#[doc(hidden)] pub const GRAPHICS_INDIRECT_DISPLAY_ABANDON_SWAPCHAIN : HRESULT = HRESULT::from_constant(0xC0262012); // ERROR_GRAPHICS_INDIRECT_DISPLAY_ABANDON_SWAPCHAIN
#[doc(hidden)] pub const GRAPHICS_INDIRECT_DISPLAY_DEVICE_STOPPED : HRESULT = HRESULT::from_constant(0xC0262013); // ERROR_GRAPHICS_INDIRECT_DISPLAY_DEVICE_STOPPED
#[doc(hidden)] pub const GRAPHICS_VAIL_FAILED_TO_SEND_CREATE_SUPERWETINK_MESSAGE : HRESULT = HRESULT::from_constant(0xC0262014); // ERROR_GRAPHICS_VAIL_FAILED_TO_SEND_CREATE_SUPERWETINK_MESSAGE
#[doc(hidden)] pub const GRAPHICS_VAIL_FAILED_TO_SEND_DESTROY_SUPERWETINK_MESSAGE : HRESULT = HRESULT::from_constant(0xC0262015); // ERROR_GRAPHICS_VAIL_FAILED_TO_SEND_DESTROY_SUPERWETINK_MESSAGE
#[doc(hidden)] pub const GRAPHICS_NO_VIDEO_MEMORY : HRESULT = HRESULT::from_constant(0xC0262100); // ERROR_GRAPHICS_NO_VIDEO_MEMORY
#[doc(hidden)] pub const GRAPHICS_CANT_LOCK_MEMORY : HRESULT = HRESULT::from_constant(0xC0262101); // ERROR_GRAPHICS_CANT_LOCK_MEMORY
#[doc(hidden)] pub const GRAPHICS_ALLOCATION_BUSY : HRESULT = HRESULT::from_constant(0xC0262102); // ERROR_GRAPHICS_ALLOCATION_BUSY
#[doc(hidden)] pub const GRAPHICS_TOO_MANY_REFERENCES : HRESULT = HRESULT::from_constant(0xC0262103); // ERROR_GRAPHICS_TOO_MANY_REFERENCES
#[doc(hidden)] pub const GRAPHICS_TRY_AGAIN_LATER : HRESULT = HRESULT::from_constant(0xC0262104); // ERROR_GRAPHICS_TRY_AGAIN_LATER
#[doc(hidden)] pub const GRAPHICS_TRY_AGAIN_NOW : HRESULT = HRESULT::from_constant(0xC0262105); // ERROR_GRAPHICS_TRY_AGAIN_NOW
#[doc(hidden)] pub const GRAPHICS_ALLOCATION_INVALID : HRESULT = HRESULT::from_constant(0xC0262106); // ERROR_GRAPHICS_ALLOCATION_INVALID
#[doc(hidden)] pub const GRAPHICS_UNSWIZZLING_APERTURE_UNAVAILABLE : HRESULT = HRESULT::from_constant(0xC0262107); // ERROR_GRAPHICS_UNSWIZZLING_APERTURE_UNAVAILABLE
#[doc(hidden)] pub const GRAPHICS_UNSWIZZLING_APERTURE_UNSUPPORTED : HRESULT = HRESULT::from_constant(0xC0262108); // ERROR_GRAPHICS_UNSWIZZLING_APERTURE_UNSUPPORTED
#[doc(hidden)] pub const GRAPHICS_CANT_EVICT_PINNED_ALLOCATION : HRESULT = HRESULT::from_constant(0xC0262109); // ERROR_GRAPHICS_CANT_EVICT_PINNED_ALLOCATION
#[doc(hidden)] pub const GRAPHICS_INVALID_ALLOCATION_USAGE : HRESULT = HRESULT::from_constant(0xC0262110); // ERROR_GRAPHICS_INVALID_ALLOCATION_USAGE
#[doc(hidden)] pub const GRAPHICS_CANT_RENDER_LOCKED_ALLOCATION : HRESULT = HRESULT::from_constant(0xC0262111); // ERROR_GRAPHICS_CANT_RENDER_LOCKED_ALLOCATION
#[doc(hidden)] pub const GRAPHICS_ALLOCATION_CLOSED : HRESULT = HRESULT::from_constant(0xC0262112); // ERROR_GRAPHICS_ALLOCATION_CLOSED
#[doc(hidden)] pub const GRAPHICS_INVALID_ALLOCATION_INSTANCE : HRESULT = HRESULT::from_constant(0xC0262113); // ERROR_GRAPHICS_INVALID_ALLOCATION_INSTANCE
#[doc(hidden)] pub const GRAPHICS_INVALID_ALLOCATION_HANDLE : HRESULT = HRESULT::from_constant(0xC0262114); // ERROR_GRAPHICS_INVALID_ALLOCATION_HANDLE
#[doc(hidden)] pub const GRAPHICS_WRONG_ALLOCATION_DEVICE : HRESULT = HRESULT::from_constant(0xC0262115); // ERROR_GRAPHICS_WRONG_ALLOCATION_DEVICE
#[doc(hidden)] pub const GRAPHICS_ALLOCATION_CONTENT_LOST : HRESULT = HRESULT::from_constant(0xC0262116); // ERROR_GRAPHICS_ALLOCATION_CONTENT_LOST
#[doc(hidden)] pub const GRAPHICS_GPU_EXCEPTION_ON_DEVICE : HRESULT = HRESULT::from_constant(0xC0262200); // ERROR_GRAPHICS_GPU_EXCEPTION_ON_DEVICE
#[doc(hidden)] pub const GRAPHICS_SKIP_ALLOCATION_PREPARATION : HRESULT = HRESULT::from_constant(0x40262201); // ERROR_GRAPHICS_SKIP_ALLOCATION_PREPARATION
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDPN_TOPOLOGY : HRESULT = HRESULT::from_constant(0xC0262300); // ERROR_GRAPHICS_INVALID_VIDPN_TOPOLOGY
#[doc(hidden)] pub const GRAPHICS_VIDPN_TOPOLOGY_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262301); // ERROR_GRAPHICS_VIDPN_TOPOLOGY_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_VIDPN_TOPOLOGY_CURRENTLY_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262302); // ERROR_GRAPHICS_VIDPN_TOPOLOGY_CURRENTLY_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDPN : HRESULT = HRESULT::from_constant(0xC0262303); // ERROR_GRAPHICS_INVALID_VIDPN
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE : HRESULT = HRESULT::from_constant(0xC0262304); // ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDEO_PRESENT_TARGET : HRESULT = HRESULT::from_constant(0xC0262305); // ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET
#[doc(hidden)] pub const GRAPHICS_VIDPN_MODALITY_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262306); // ERROR_GRAPHICS_VIDPN_MODALITY_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_MODE_NOT_PINNED : HRESULT = HRESULT::from_constant(0x00262307); // ERROR_GRAPHICS_MODE_NOT_PINNED
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDPN_SOURCEMODESET : HRESULT = HRESULT::from_constant(0xC0262308); // ERROR_GRAPHICS_INVALID_VIDPN_SOURCEMODESET
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDPN_TARGETMODESET : HRESULT = HRESULT::from_constant(0xC0262309); // ERROR_GRAPHICS_INVALID_VIDPN_TARGETMODESET
#[doc(hidden)] pub const GRAPHICS_INVALID_FREQUENCY : HRESULT = HRESULT::from_constant(0xC026230A); // ERROR_GRAPHICS_INVALID_FREQUENCY
#[doc(hidden)] pub const GRAPHICS_INVALID_ACTIVE_REGION : HRESULT = HRESULT::from_constant(0xC026230B); // ERROR_GRAPHICS_INVALID_ACTIVE_REGION
#[doc(hidden)] pub const GRAPHICS_INVALID_TOTAL_REGION : HRESULT = HRESULT::from_constant(0xC026230C); // ERROR_GRAPHICS_INVALID_TOTAL_REGION
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE_MODE : HRESULT = HRESULT::from_constant(0xC0262310); // ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_SOURCE_MODE
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDEO_PRESENT_TARGET_MODE : HRESULT = HRESULT::from_constant(0xC0262311); // ERROR_GRAPHICS_INVALID_VIDEO_PRESENT_TARGET_MODE
#[doc(hidden)] pub const GRAPHICS_PINNED_MODE_MUST_REMAIN_IN_SET : HRESULT = HRESULT::from_constant(0xC0262312); // ERROR_GRAPHICS_PINNED_MODE_MUST_REMAIN_IN_SET
#[doc(hidden)] pub const GRAPHICS_PATH_ALREADY_IN_TOPOLOGY : HRESULT = HRESULT::from_constant(0xC0262313); // ERROR_GRAPHICS_PATH_ALREADY_IN_TOPOLOGY
#[doc(hidden)] pub const GRAPHICS_MODE_ALREADY_IN_MODESET : HRESULT = HRESULT::from_constant(0xC0262314); // ERROR_GRAPHICS_MODE_ALREADY_IN_MODESET
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDEOPRESENTSOURCESET : HRESULT = HRESULT::from_constant(0xC0262315); // ERROR_GRAPHICS_INVALID_VIDEOPRESENTSOURCESET
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDEOPRESENTTARGETSET : HRESULT = HRESULT::from_constant(0xC0262316); // ERROR_GRAPHICS_INVALID_VIDEOPRESENTTARGETSET
#[doc(hidden)] pub const GRAPHICS_SOURCE_ALREADY_IN_SET : HRESULT = HRESULT::from_constant(0xC0262317); // ERROR_GRAPHICS_SOURCE_ALREADY_IN_SET
#[doc(hidden)] pub const GRAPHICS_TARGET_ALREADY_IN_SET : HRESULT = HRESULT::from_constant(0xC0262318); // ERROR_GRAPHICS_TARGET_ALREADY_IN_SET
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDPN_PRESENT_PATH : HRESULT = HRESULT::from_constant(0xC0262319); // ERROR_GRAPHICS_INVALID_VIDPN_PRESENT_PATH
#[doc(hidden)] pub const GRAPHICS_NO_RECOMMENDED_VIDPN_TOPOLOGY : HRESULT = HRESULT::from_constant(0xC026231A); // ERROR_GRAPHICS_NO_RECOMMENDED_VIDPN_TOPOLOGY
#[doc(hidden)] pub const GRAPHICS_INVALID_MONITOR_FREQUENCYRANGESET : HRESULT = HRESULT::from_constant(0xC026231B); // ERROR_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGESET
#[doc(hidden)] pub const GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE : HRESULT = HRESULT::from_constant(0xC026231C); // ERROR_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE
#[doc(hidden)] pub const GRAPHICS_FREQUENCYRANGE_NOT_IN_SET : HRESULT = HRESULT::from_constant(0xC026231D); // ERROR_GRAPHICS_FREQUENCYRANGE_NOT_IN_SET
#[doc(hidden)] pub const GRAPHICS_NO_PREFERRED_MODE : HRESULT = HRESULT::from_constant(0x0026231E); // ERROR_GRAPHICS_NO_PREFERRED_MODE
#[doc(hidden)] pub const GRAPHICS_FREQUENCYRANGE_ALREADY_IN_SET : HRESULT = HRESULT::from_constant(0xC026231F); // ERROR_GRAPHICS_FREQUENCYRANGE_ALREADY_IN_SET
#[doc(hidden)] pub const GRAPHICS_STALE_MODESET : HRESULT = HRESULT::from_constant(0xC0262320); // ERROR_GRAPHICS_STALE_MODESET
#[doc(hidden)] pub const GRAPHICS_INVALID_MONITOR_SOURCEMODESET : HRESULT = HRESULT::from_constant(0xC0262321); // ERROR_GRAPHICS_INVALID_MONITOR_SOURCEMODESET
#[doc(hidden)] pub const GRAPHICS_INVALID_MONITOR_SOURCE_MODE : HRESULT = HRESULT::from_constant(0xC0262322); // ERROR_GRAPHICS_INVALID_MONITOR_SOURCE_MODE
#[doc(hidden)] pub const GRAPHICS_NO_RECOMMENDED_FUNCTIONAL_VIDPN : HRESULT = HRESULT::from_constant(0xC0262323); // ERROR_GRAPHICS_NO_RECOMMENDED_FUNCTIONAL_VIDPN
#[doc(hidden)] pub const GRAPHICS_MODE_ID_MUST_BE_UNIQUE : HRESULT = HRESULT::from_constant(0xC0262324); // ERROR_GRAPHICS_MODE_ID_MUST_BE_UNIQUE
#[doc(hidden)] pub const GRAPHICS_EMPTY_ADAPTER_MONITOR_MODE_SUPPORT_INTERSECTION : HRESULT = HRESULT::from_constant(0xC0262325); // ERROR_GRAPHICS_EMPTY_ADAPTER_MONITOR_MODE_SUPPORT_INTERSECTION
#[doc(hidden)] pub const GRAPHICS_VIDEO_PRESENT_TARGETS_LESS_THAN_SOURCES : HRESULT = HRESULT::from_constant(0xC0262326); // ERROR_GRAPHICS_VIDEO_PRESENT_TARGETS_LESS_THAN_SOURCES
#[doc(hidden)] pub const GRAPHICS_PATH_NOT_IN_TOPOLOGY : HRESULT = HRESULT::from_constant(0xC0262327); // ERROR_GRAPHICS_PATH_NOT_IN_TOPOLOGY
#[doc(hidden)] pub const GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_SOURCE : HRESULT = HRESULT::from_constant(0xC0262328); // ERROR_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_SOURCE
#[doc(hidden)] pub const GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_TARGET : HRESULT = HRESULT::from_constant(0xC0262329); // ERROR_GRAPHICS_ADAPTER_MUST_HAVE_AT_LEAST_ONE_TARGET
#[doc(hidden)] pub const GRAPHICS_INVALID_MONITORDESCRIPTORSET : HRESULT = HRESULT::from_constant(0xC026232A); // ERROR_GRAPHICS_INVALID_MONITORDESCRIPTORSET
#[doc(hidden)] pub const GRAPHICS_INVALID_MONITORDESCRIPTOR : HRESULT = HRESULT::from_constant(0xC026232B); // ERROR_GRAPHICS_INVALID_MONITORDESCRIPTOR
#[doc(hidden)] pub const GRAPHICS_MONITORDESCRIPTOR_NOT_IN_SET : HRESULT = HRESULT::from_constant(0xC026232C); // ERROR_GRAPHICS_MONITORDESCRIPTOR_NOT_IN_SET
#[doc(hidden)] pub const GRAPHICS_MONITORDESCRIPTOR_ALREADY_IN_SET : HRESULT = HRESULT::from_constant(0xC026232D); // ERROR_GRAPHICS_MONITORDESCRIPTOR_ALREADY_IN_SET
#[doc(hidden)] pub const GRAPHICS_MONITORDESCRIPTOR_ID_MUST_BE_UNIQUE : HRESULT = HRESULT::from_constant(0xC026232E); // ERROR_GRAPHICS_MONITORDESCRIPTOR_ID_MUST_BE_UNIQUE
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDPN_TARGET_SUBSET_TYPE : HRESULT = HRESULT::from_constant(0xC026232F); // ERROR_GRAPHICS_INVALID_VIDPN_TARGET_SUBSET_TYPE
#[doc(hidden)] pub const GRAPHICS_RESOURCES_NOT_RELATED : HRESULT = HRESULT::from_constant(0xC0262330); // ERROR_GRAPHICS_RESOURCES_NOT_RELATED
#[doc(hidden)] pub const GRAPHICS_SOURCE_ID_MUST_BE_UNIQUE : HRESULT = HRESULT::from_constant(0xC0262331); // ERROR_GRAPHICS_SOURCE_ID_MUST_BE_UNIQUE
#[doc(hidden)] pub const GRAPHICS_TARGET_ID_MUST_BE_UNIQUE : HRESULT = HRESULT::from_constant(0xC0262332); // ERROR_GRAPHICS_TARGET_ID_MUST_BE_UNIQUE
#[doc(hidden)] pub const GRAPHICS_NO_AVAILABLE_VIDPN_TARGET : HRESULT = HRESULT::from_constant(0xC0262333); // ERROR_GRAPHICS_NO_AVAILABLE_VIDPN_TARGET
#[doc(hidden)] pub const GRAPHICS_MONITOR_COULD_NOT_BE_ASSOCIATED_WITH_ADAPTER : HRESULT = HRESULT::from_constant(0xC0262334); // ERROR_GRAPHICS_MONITOR_COULD_NOT_BE_ASSOCIATED_WITH_ADAPTER
#[doc(hidden)] pub const GRAPHICS_NO_VIDPNMGR : HRESULT = HRESULT::from_constant(0xC0262335); // ERROR_GRAPHICS_NO_VIDPNMGR
#[doc(hidden)] pub const GRAPHICS_NO_ACTIVE_VIDPN : HRESULT = HRESULT::from_constant(0xC0262336); // ERROR_GRAPHICS_NO_ACTIVE_VIDPN
#[doc(hidden)] pub const GRAPHICS_STALE_VIDPN_TOPOLOGY : HRESULT = HRESULT::from_constant(0xC0262337); // ERROR_GRAPHICS_STALE_VIDPN_TOPOLOGY
#[doc(hidden)] pub const GRAPHICS_MONITOR_NOT_CONNECTED : HRESULT = HRESULT::from_constant(0xC0262338); // ERROR_GRAPHICS_MONITOR_NOT_CONNECTED
#[doc(hidden)] pub const GRAPHICS_SOURCE_NOT_IN_TOPOLOGY : HRESULT = HRESULT::from_constant(0xC0262339); // ERROR_GRAPHICS_SOURCE_NOT_IN_TOPOLOGY
#[doc(hidden)] pub const GRAPHICS_INVALID_PRIMARYSURFACE_SIZE : HRESULT = HRESULT::from_constant(0xC026233A); // ERROR_GRAPHICS_INVALID_PRIMARYSURFACE_SIZE
#[doc(hidden)] pub const GRAPHICS_INVALID_VISIBLEREGION_SIZE : HRESULT = HRESULT::from_constant(0xC026233B); // ERROR_GRAPHICS_INVALID_VISIBLEREGION_SIZE
#[doc(hidden)] pub const GRAPHICS_INVALID_STRIDE : HRESULT = HRESULT::from_constant(0xC026233C); // ERROR_GRAPHICS_INVALID_STRIDE
#[doc(hidden)] pub const GRAPHICS_INVALID_PIXELFORMAT : HRESULT = HRESULT::from_constant(0xC026233D); // ERROR_GRAPHICS_INVALID_PIXELFORMAT
#[doc(hidden)] pub const GRAPHICS_INVALID_COLORBASIS : HRESULT = HRESULT::from_constant(0xC026233E); // ERROR_GRAPHICS_INVALID_COLORBASIS
#[doc(hidden)] pub const GRAPHICS_INVALID_PIXELVALUEACCESSMODE : HRESULT = HRESULT::from_constant(0xC026233F); // ERROR_GRAPHICS_INVALID_PIXELVALUEACCESSMODE
#[doc(hidden)] pub const GRAPHICS_TARGET_NOT_IN_TOPOLOGY : HRESULT = HRESULT::from_constant(0xC0262340); // ERROR_GRAPHICS_TARGET_NOT_IN_TOPOLOGY
#[doc(hidden)] pub const GRAPHICS_NO_DISPLAY_MODE_MANAGEMENT_SUPPORT : HRESULT = HRESULT::from_constant(0xC0262341); // ERROR_GRAPHICS_NO_DISPLAY_MODE_MANAGEMENT_SUPPORT
#[doc(hidden)] pub const GRAPHICS_VIDPN_SOURCE_IN_USE : HRESULT = HRESULT::from_constant(0xC0262342); // ERROR_GRAPHICS_VIDPN_SOURCE_IN_USE
#[doc(hidden)] pub const GRAPHICS_CANT_ACCESS_ACTIVE_VIDPN : HRESULT = HRESULT::from_constant(0xC0262343); // ERROR_GRAPHICS_CANT_ACCESS_ACTIVE_VIDPN
#[doc(hidden)] pub const GRAPHICS_INVALID_PATH_IMPORTANCE_ORDINAL : HRESULT = HRESULT::from_constant(0xC0262344); // ERROR_GRAPHICS_INVALID_PATH_IMPORTANCE_ORDINAL
#[doc(hidden)] pub const GRAPHICS_INVALID_PATH_CONTENT_GEOMETRY_TRANSFORMATION : HRESULT = HRESULT::from_constant(0xC0262345); // ERROR_GRAPHICS_INVALID_PATH_CONTENT_GEOMETRY_TRANSFORMATION
#[doc(hidden)] pub const GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262346); // ERROR_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_INVALID_GAMMA_RAMP : HRESULT = HRESULT::from_constant(0xC0262347); // ERROR_GRAPHICS_INVALID_GAMMA_RAMP
#[doc(hidden)] pub const GRAPHICS_GAMMA_RAMP_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262348); // ERROR_GRAPHICS_GAMMA_RAMP_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_MULTISAMPLING_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262349); // ERROR_GRAPHICS_MULTISAMPLING_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_MODE_NOT_IN_MODESET : HRESULT = HRESULT::from_constant(0xC026234A); // ERROR_GRAPHICS_MODE_NOT_IN_MODESET
#[doc(hidden)] pub const GRAPHICS_DATASET_IS_EMPTY : HRESULT = HRESULT::from_constant(0x0026234B); // ERROR_GRAPHICS_DATASET_IS_EMPTY
#[doc(hidden)] pub const GRAPHICS_NO_MORE_ELEMENTS_IN_DATASET : HRESULT = HRESULT::from_constant(0x0026234C); // ERROR_GRAPHICS_NO_MORE_ELEMENTS_IN_DATASET
#[doc(hidden)] pub const GRAPHICS_INVALID_VIDPN_TOPOLOGY_RECOMMENDATION_REASON : HRESULT = HRESULT::from_constant(0xC026234D); // ERROR_GRAPHICS_INVALID_VIDPN_TOPOLOGY_RECOMMENDATION_REASON
#[doc(hidden)] pub const GRAPHICS_INVALID_PATH_CONTENT_TYPE : HRESULT = HRESULT::from_constant(0xC026234E); // ERROR_GRAPHICS_INVALID_PATH_CONTENT_TYPE
#[doc(hidden)] pub const GRAPHICS_INVALID_COPYPROTECTION_TYPE : HRESULT = HRESULT::from_constant(0xC026234F); // ERROR_GRAPHICS_INVALID_COPYPROTECTION_TYPE
#[doc(hidden)] pub const GRAPHICS_UNASSIGNED_MODESET_ALREADY_EXISTS : HRESULT = HRESULT::from_constant(0xC0262350); // ERROR_GRAPHICS_UNASSIGNED_MODESET_ALREADY_EXISTS
#[doc(hidden)] pub const GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_PINNED : HRESULT = HRESULT::from_constant(0x00262351); // ERROR_GRAPHICS_PATH_CONTENT_GEOMETRY_TRANSFORMATION_NOT_PINNED
#[doc(hidden)] pub const GRAPHICS_INVALID_SCANLINE_ORDERING : HRESULT = HRESULT::from_constant(0xC0262352); // ERROR_GRAPHICS_INVALID_SCANLINE_ORDERING
#[doc(hidden)] pub const GRAPHICS_TOPOLOGY_CHANGES_NOT_ALLOWED : HRESULT = HRESULT::from_constant(0xC0262353); // ERROR_GRAPHICS_TOPOLOGY_CHANGES_NOT_ALLOWED
#[doc(hidden)] pub const GRAPHICS_NO_AVAILABLE_IMPORTANCE_ORDINALS : HRESULT = HRESULT::from_constant(0xC0262354); // ERROR_GRAPHICS_NO_AVAILABLE_IMPORTANCE_ORDINALS
#[doc(hidden)] pub const GRAPHICS_INCOMPATIBLE_PRIVATE_FORMAT : HRESULT = HRESULT::from_constant(0xC0262355); // ERROR_GRAPHICS_INCOMPATIBLE_PRIVATE_FORMAT
#[doc(hidden)] pub const GRAPHICS_INVALID_MODE_PRUNING_ALGORITHM : HRESULT = HRESULT::from_constant(0xC0262356); // ERROR_GRAPHICS_INVALID_MODE_PRUNING_ALGORITHM
#[doc(hidden)] pub const GRAPHICS_INVALID_MONITOR_CAPABILITY_ORIGIN : HRESULT = HRESULT::from_constant(0xC0262357); // ERROR_GRAPHICS_INVALID_MONITOR_CAPABILITY_ORIGIN
#[doc(hidden)] pub const GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE_CONSTRAINT : HRESULT = HRESULT::from_constant(0xC0262358); // ERROR_GRAPHICS_INVALID_MONITOR_FREQUENCYRANGE_CONSTRAINT
#[doc(hidden)] pub const GRAPHICS_MAX_NUM_PATHS_REACHED : HRESULT = HRESULT::from_constant(0xC0262359); // ERROR_GRAPHICS_MAX_NUM_PATHS_REACHED
#[doc(hidden)] pub const GRAPHICS_CANCEL_VIDPN_TOPOLOGY_AUGMENTATION : HRESULT = HRESULT::from_constant(0xC026235A); // ERROR_GRAPHICS_CANCEL_VIDPN_TOPOLOGY_AUGMENTATION
#[doc(hidden)] pub const GRAPHICS_INVALID_CLIENT_TYPE : HRESULT = HRESULT::from_constant(0xC026235B); // ERROR_GRAPHICS_INVALID_CLIENT_TYPE
#[doc(hidden)] pub const GRAPHICS_CLIENTVIDPN_NOT_SET : HRESULT = HRESULT::from_constant(0xC026235C); // ERROR_GRAPHICS_CLIENTVIDPN_NOT_SET
#[doc(hidden)] pub const GRAPHICS_SPECIFIED_CHILD_ALREADY_CONNECTED : HRESULT = HRESULT::from_constant(0xC0262400); // ERROR_GRAPHICS_SPECIFIED_CHILD_ALREADY_CONNECTED
#[doc(hidden)] pub const GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262401); // ERROR_GRAPHICS_CHILD_DESCRIPTOR_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_UNKNOWN_CHILD_STATUS : HRESULT = HRESULT::from_constant(0x4026242F); // ERROR_GRAPHICS_UNKNOWN_CHILD_STATUS
#[doc(hidden)] pub const GRAPHICS_NOT_A_LINKED_ADAPTER : HRESULT = HRESULT::from_constant(0xC0262430); // ERROR_GRAPHICS_NOT_A_LINKED_ADAPTER
#[doc(hidden)] pub const GRAPHICS_LEADLINK_NOT_ENUMERATED : HRESULT = HRESULT::from_constant(0xC0262431); // ERROR_GRAPHICS_LEADLINK_NOT_ENUMERATED
#[doc(hidden)] pub const GRAPHICS_CHAINLINKS_NOT_ENUMERATED : HRESULT = HRESULT::from_constant(0xC0262432); // ERROR_GRAPHICS_CHAINLINKS_NOT_ENUMERATED
#[doc(hidden)] pub const GRAPHICS_ADAPTER_CHAIN_NOT_READY : HRESULT = HRESULT::from_constant(0xC0262433); // ERROR_GRAPHICS_ADAPTER_CHAIN_NOT_READY
#[doc(hidden)] pub const GRAPHICS_CHAINLINKS_NOT_STARTED : HRESULT = HRESULT::from_constant(0xC0262434); // ERROR_GRAPHICS_CHAINLINKS_NOT_STARTED
#[doc(hidden)] pub const GRAPHICS_CHAINLINKS_NOT_POWERED_ON : HRESULT = HRESULT::from_constant(0xC0262435); // ERROR_GRAPHICS_CHAINLINKS_NOT_POWERED_ON
#[doc(hidden)] pub const GRAPHICS_INCONSISTENT_DEVICE_LINK_STATE : HRESULT = HRESULT::from_constant(0xC0262436); // ERROR_GRAPHICS_INCONSISTENT_DEVICE_LINK_STATE
#[doc(hidden)] pub const GRAPHICS_LEADLINK_START_DEFERRED : HRESULT = HRESULT::from_constant(0x40262437); // ERROR_GRAPHICS_LEADLINK_START_DEFERRED
#[doc(hidden)] pub const GRAPHICS_NOT_POST_DEVICE_DRIVER : HRESULT = HRESULT::from_constant(0xC0262438); // ERROR_GRAPHICS_NOT_POST_DEVICE_DRIVER
#[doc(hidden)] pub const GRAPHICS_POLLING_TOO_FREQUENTLY : HRESULT = HRESULT::from_constant(0x40262439); // ERROR_GRAPHICS_POLLING_TOO_FREQUENTLY
#[doc(hidden)] pub const GRAPHICS_START_DEFERRED : HRESULT = HRESULT::from_constant(0x4026243A); // ERROR_GRAPHICS_START_DEFERRED
#[doc(hidden)] pub const GRAPHICS_ADAPTER_ACCESS_NOT_EXCLUDED : HRESULT = HRESULT::from_constant(0xC026243B); // ERROR_GRAPHICS_ADAPTER_ACCESS_NOT_EXCLUDED
#[doc(hidden)] pub const GRAPHICS_DEPENDABLE_CHILD_STATUS : HRESULT = HRESULT::from_constant(0x4026243C); // ERROR_GRAPHICS_DEPENDABLE_CHILD_STATUS
#[doc(hidden)] pub const GRAPHICS_OPM_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262500); // ERROR_GRAPHICS_OPM_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_COPP_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262501); // ERROR_GRAPHICS_COPP_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_UAB_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262502); // ERROR_GRAPHICS_UAB_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_OPM_INVALID_ENCRYPTED_PARAMETERS : HRESULT = HRESULT::from_constant(0xC0262503); // ERROR_GRAPHICS_OPM_INVALID_ENCRYPTED_PARAMETERS
#[doc(hidden)] pub const GRAPHICS_OPM_NO_VIDEO_OUTPUTS_EXIST : HRESULT = HRESULT::from_constant(0xC0262505); // ERROR_GRAPHICS_OPM_NO_VIDEO_OUTPUTS_EXIST
#[doc(hidden)] pub const GRAPHICS_OPM_INTERNAL_ERROR : HRESULT = HRESULT::from_constant(0xC026250B); // ERROR_GRAPHICS_OPM_INTERNAL_ERROR
#[doc(hidden)] pub const GRAPHICS_OPM_INVALID_HANDLE : HRESULT = HRESULT::from_constant(0xC026250C); // ERROR_GRAPHICS_OPM_INVALID_HANDLE
#[doc(hidden)] pub const GRAPHICS_PVP_INVALID_CERTIFICATE_LENGTH : HRESULT = HRESULT::from_constant(0xC026250E); // ERROR_GRAPHICS_PVP_INVALID_CERTIFICATE_LENGTH
#[doc(hidden)] pub const GRAPHICS_OPM_SPANNING_MODE_ENABLED : HRESULT = HRESULT::from_constant(0xC026250F); // ERROR_GRAPHICS_OPM_SPANNING_MODE_ENABLED
#[doc(hidden)] pub const GRAPHICS_OPM_THEATER_MODE_ENABLED : HRESULT = HRESULT::from_constant(0xC0262510); // ERROR_GRAPHICS_OPM_THEATER_MODE_ENABLED
#[doc(hidden)] pub const GRAPHICS_PVP_HFS_FAILED : HRESULT = HRESULT::from_constant(0xC0262511); // ERROR_GRAPHICS_PVP_HFS_FAILED
#[doc(hidden)] pub const GRAPHICS_OPM_INVALID_SRM : HRESULT = HRESULT::from_constant(0xC0262512); // ERROR_GRAPHICS_OPM_INVALID_SRM
#[doc(hidden)] pub const GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_HDCP : HRESULT = HRESULT::from_constant(0xC0262513); // ERROR_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_HDCP
#[doc(hidden)] pub const GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_ACP : HRESULT = HRESULT::from_constant(0xC0262514); // ERROR_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_ACP
#[doc(hidden)] pub const GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_CGMSA : HRESULT = HRESULT::from_constant(0xC0262515); // ERROR_GRAPHICS_OPM_OUTPUT_DOES_NOT_SUPPORT_CGMSA
#[doc(hidden)] pub const GRAPHICS_OPM_HDCP_SRM_NEVER_SET : HRESULT = HRESULT::from_constant(0xC0262516); // ERROR_GRAPHICS_OPM_HDCP_SRM_NEVER_SET
#[doc(hidden)] pub const GRAPHICS_OPM_RESOLUTION_TOO_HIGH : HRESULT = HRESULT::from_constant(0xC0262517); // ERROR_GRAPHICS_OPM_RESOLUTION_TOO_HIGH
#[doc(hidden)] pub const GRAPHICS_OPM_ALL_HDCP_HARDWARE_ALREADY_IN_USE : HRESULT = HRESULT::from_constant(0xC0262518); // ERROR_GRAPHICS_OPM_ALL_HDCP_HARDWARE_ALREADY_IN_USE
#[doc(hidden)] pub const GRAPHICS_OPM_VIDEO_OUTPUT_NO_LONGER_EXISTS : HRESULT = HRESULT::from_constant(0xC026251A); // ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_NO_LONGER_EXISTS
#[doc(hidden)] pub const GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS : HRESULT = HRESULT::from_constant(0xC026251B); // ERROR_GRAPHICS_OPM_SESSION_TYPE_CHANGE_IN_PROGRESS
#[doc(hidden)] pub const GRAPHICS_OPM_VIDEO_OUTPUT_DOES_NOT_HAVE_COPP_SEMANTICS : HRESULT = HRESULT::from_constant(0xC026251C); // ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_DOES_NOT_HAVE_COPP_SEMANTICS
#[doc(hidden)] pub const GRAPHICS_OPM_INVALID_INFORMATION_REQUEST : HRESULT = HRESULT::from_constant(0xC026251D); // ERROR_GRAPHICS_OPM_INVALID_INFORMATION_REQUEST
#[doc(hidden)] pub const GRAPHICS_OPM_DRIVER_INTERNAL_ERROR : HRESULT = HRESULT::from_constant(0xC026251E); // ERROR_GRAPHICS_OPM_DRIVER_INTERNAL_ERROR
#[doc(hidden)] pub const GRAPHICS_OPM_VIDEO_OUTPUT_DOES_NOT_HAVE_OPM_SEMANTICS : HRESULT = HRESULT::from_constant(0xC026251F); // ERROR_GRAPHICS_OPM_VIDEO_OUTPUT_DOES_NOT_HAVE_OPM_SEMANTICS
#[doc(hidden)] pub const GRAPHICS_OPM_SIGNALING_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262520); // ERROR_GRAPHICS_OPM_SIGNALING_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_OPM_INVALID_CONFIGURATION_REQUEST : HRESULT = HRESULT::from_constant(0xC0262521); // ERROR_GRAPHICS_OPM_INVALID_CONFIGURATION_REQUEST
#[doc(hidden)] pub const GRAPHICS_I2C_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262580); // ERROR_GRAPHICS_I2C_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_I2C_DEVICE_DOES_NOT_EXIST : HRESULT = HRESULT::from_constant(0xC0262581); // ERROR_GRAPHICS_I2C_DEVICE_DOES_NOT_EXIST
#[doc(hidden)] pub const GRAPHICS_I2C_ERROR_TRANSMITTING_DATA : HRESULT = HRESULT::from_constant(0xC0262582); // ERROR_GRAPHICS_I2C_ERROR_TRANSMITTING_DATA
#[doc(hidden)] pub const GRAPHICS_I2C_ERROR_RECEIVING_DATA : HRESULT = HRESULT::from_constant(0xC0262583); // ERROR_GRAPHICS_I2C_ERROR_RECEIVING_DATA
#[doc(hidden)] pub const GRAPHICS_DDCCI_VCP_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0262584); // ERROR_GRAPHICS_DDCCI_VCP_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_DDCCI_INVALID_DATA : HRESULT = HRESULT::from_constant(0xC0262585); // ERROR_GRAPHICS_DDCCI_INVALID_DATA
#[doc(hidden)] pub const GRAPHICS_DDCCI_MONITOR_RETURNED_INVALID_TIMING_STATUS_BYTE : HRESULT = HRESULT::from_constant(0xC0262586); // ERROR_GRAPHICS_DDCCI_MONITOR_RETURNED_INVALID_TIMING_STATUS_BYTE
#[doc(hidden)] pub const GRAPHICS_MCA_INVALID_CAPABILITIES_STRING : HRESULT = HRESULT::from_constant(0xC0262587); // ERROR_GRAPHICS_MCA_INVALID_CAPABILITIES_STRING
#[doc(hidden)] pub const GRAPHICS_MCA_INTERNAL_ERROR : HRESULT = HRESULT::from_constant(0xC0262588); // ERROR_GRAPHICS_MCA_INTERNAL_ERROR
#[doc(hidden)] pub const GRAPHICS_DDCCI_INVALID_MESSAGE_COMMAND : HRESULT = HRESULT::from_constant(0xC0262589); // ERROR_GRAPHICS_DDCCI_INVALID_MESSAGE_COMMAND
#[doc(hidden)] pub const GRAPHICS_DDCCI_INVALID_MESSAGE_LENGTH : HRESULT = HRESULT::from_constant(0xC026258A); // ERROR_GRAPHICS_DDCCI_INVALID_MESSAGE_LENGTH
#[doc(hidden)] pub const GRAPHICS_DDCCI_INVALID_MESSAGE_CHECKSUM : HRESULT = HRESULT::from_constant(0xC026258B); // ERROR_GRAPHICS_DDCCI_INVALID_MESSAGE_CHECKSUM
#[doc(hidden)] pub const GRAPHICS_INVALID_PHYSICAL_MONITOR_HANDLE : HRESULT = HRESULT::from_constant(0xC026258C); // ERROR_GRAPHICS_INVALID_PHYSICAL_MONITOR_HANDLE
#[doc(hidden)] pub const GRAPHICS_MONITOR_NO_LONGER_EXISTS : HRESULT = HRESULT::from_constant(0xC026258D); // ERROR_GRAPHICS_MONITOR_NO_LONGER_EXISTS
#[doc(hidden)] pub const GRAPHICS_DDCCI_CURRENT_CURRENT_VALUE_GREATER_THAN_MAXIMUM_VALUE : HRESULT = HRESULT::from_constant(0xC02625D8); // ERROR_GRAPHICS_DDCCI_CURRENT_CURRENT_VALUE_GREATER_THAN_MAXIMUM_VALUE
#[doc(hidden)] pub const GRAPHICS_MCA_INVALID_VCP_VERSION : HRESULT = HRESULT::from_constant(0xC02625D9); // ERROR_GRAPHICS_MCA_INVALID_VCP_VERSION
#[doc(hidden)] pub const GRAPHICS_MCA_MONITOR_VIOLATES_MCCS_SPECIFICATION : HRESULT = HRESULT::from_constant(0xC02625DA); // ERROR_GRAPHICS_MCA_MONITOR_VIOLATES_MCCS_SPECIFICATION
#[doc(hidden)] pub const GRAPHICS_MCA_MCCS_VERSION_MISMATCH : HRESULT = HRESULT::from_constant(0xC02625DB); // ERROR_GRAPHICS_MCA_MCCS_VERSION_MISMATCH
#[doc(hidden)] pub const GRAPHICS_MCA_UNSUPPORTED_MCCS_VERSION : HRESULT = HRESULT::from_constant(0xC02625DC); // ERROR_GRAPHICS_MCA_UNSUPPORTED_MCCS_VERSION
#[doc(hidden)] pub const GRAPHICS_MCA_INVALID_TECHNOLOGY_TYPE_RETURNED : HRESULT = HRESULT::from_constant(0xC02625DE); // ERROR_GRAPHICS_MCA_INVALID_TECHNOLOGY_TYPE_RETURNED
#[doc(hidden)] pub const GRAPHICS_MCA_UNSUPPORTED_COLOR_TEMPERATURE : HRESULT = HRESULT::from_constant(0xC02625DF); // ERROR_GRAPHICS_MCA_UNSUPPORTED_COLOR_TEMPERATURE
#[doc(hidden)] pub const GRAPHICS_ONLY_CONSOLE_SESSION_SUPPORTED : HRESULT = HRESULT::from_constant(0xC02625E0); // ERROR_GRAPHICS_ONLY_CONSOLE_SESSION_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME : HRESULT = HRESULT::from_constant(0xC02625E1); // ERROR_GRAPHICS_NO_DISPLAY_DEVICE_CORRESPONDS_TO_NAME
#[doc(hidden)] pub const GRAPHICS_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP : HRESULT = HRESULT::from_constant(0xC02625E2); // ERROR_GRAPHICS_DISPLAY_DEVICE_NOT_ATTACHED_TO_DESKTOP
#[doc(hidden)] pub const GRAPHICS_MIRRORING_DEVICES_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC02625E3); // ERROR_GRAPHICS_MIRRORING_DEVICES_NOT_SUPPORTED
#[doc(hidden)] pub const GRAPHICS_INVALID_POINTER : HRESULT = HRESULT::from_constant(0xC02625E4); // ERROR_GRAPHICS_INVALID_POINTER
#[doc(hidden)] pub const GRAPHICS_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE : HRESULT = HRESULT::from_constant(0xC02625E5); // ERROR_GRAPHICS_NO_MONITORS_CORRESPOND_TO_DISPLAY_DEVICE
#[doc(hidden)] pub const GRAPHICS_PARAMETER_ARRAY_TOO_SMALL : HRESULT = HRESULT::from_constant(0xC02625E6); // ERROR_GRAPHICS_PARAMETER_ARRAY_TOO_SMALL
#[doc(hidden)] pub const GRAPHICS_INTERNAL_ERROR : HRESULT = HRESULT::from_constant(0xC02625E7); // ERROR_GRAPHICS_INTERNAL_ERROR
#[doc(hidden)] pub const GRAPHICS_SESSION_TYPE_CHANGE_IN_PROGRESS : HRESULT = HRESULT::from_constant(0xC02605E8); // ERROR_GRAPHICS_SESSION_TYPE_CHANGE_IN_PROGRESS
#[doc(hidden)] pub const NDIS_INTERFACE_CLOSING : HRESULT = HRESULT::from_constant(0x80340002); // ERROR_NDIS_INTERFACE_CLOSING
#[doc(hidden)] pub const NDIS_BAD_VERSION : HRESULT = HRESULT::from_constant(0x80340004); // ERROR_NDIS_BAD_VERSION
#[doc(hidden)] pub const NDIS_BAD_CHARACTERISTICS : HRESULT = HRESULT::from_constant(0x80340005); // ERROR_NDIS_BAD_CHARACTERISTICS
#[doc(hidden)] pub const NDIS_ADAPTER_NOT_FOUND : HRESULT = HRESULT::from_constant(0x80340006); // ERROR_NDIS_ADAPTER_NOT_FOUND
#[doc(hidden)] pub const NDIS_OPEN_FAILED : HRESULT = HRESULT::from_constant(0x80340007); // ERROR_NDIS_OPEN_FAILED
#[doc(hidden)] pub const NDIS_DEVICE_FAILED : HRESULT = HRESULT::from_constant(0x80340008); // ERROR_NDIS_DEVICE_FAILED
#[doc(hidden)] pub const NDIS_MULTICAST_FULL : HRESULT = HRESULT::from_constant(0x80340009); // ERROR_NDIS_MULTICAST_FULL
#[doc(hidden)] pub const NDIS_MULTICAST_EXISTS : HRESULT = HRESULT::from_constant(0x8034000A); // ERROR_NDIS_MULTICAST_EXISTS
#[doc(hidden)] pub const NDIS_MULTICAST_NOT_FOUND : HRESULT = HRESULT::from_constant(0x8034000B); // ERROR_NDIS_MULTICAST_NOT_FOUND
#[doc(hidden)] pub const NDIS_REQUEST_ABORTED : HRESULT = HRESULT::from_constant(0x8034000C); // ERROR_NDIS_REQUEST_ABORTED
#[doc(hidden)] pub const NDIS_RESET_IN_PROGRESS : HRESULT = HRESULT::from_constant(0x8034000D); // ERROR_NDIS_RESET_IN_PROGRESS
#[doc(hidden)] pub const NDIS_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0x803400BB); // ERROR_NDIS_NOT_SUPPORTED
#[doc(hidden)] pub const NDIS_INVALID_PACKET : HRESULT = HRESULT::from_constant(0x8034000F); // ERROR_NDIS_INVALID_PACKET
#[doc(hidden)] pub const NDIS_ADAPTER_NOT_READY : HRESULT = HRESULT::from_constant(0x80340011); // ERROR_NDIS_ADAPTER_NOT_READY
#[doc(hidden)] pub const NDIS_INVALID_LENGTH : HRESULT = HRESULT::from_constant(0x80340014); // ERROR_NDIS_INVALID_LENGTH
#[doc(hidden)] pub const NDIS_INVALID_DATA : HRESULT = HRESULT::from_constant(0x80340015); // ERROR_NDIS_INVALID_DATA
#[doc(hidden)] pub const NDIS_BUFFER_TOO_SHORT : HRESULT = HRESULT::from_constant(0x80340016); // ERROR_NDIS_BUFFER_TOO_SHORT
#[doc(hidden)] pub const NDIS_INVALID_OID : HRESULT = HRESULT::from_constant(0x80340017); // ERROR_NDIS_INVALID_OID
#[doc(hidden)] pub const NDIS_ADAPTER_REMOVED : HRESULT = HRESULT::from_constant(0x80340018); // ERROR_NDIS_ADAPTER_REMOVED
#[doc(hidden)] pub const NDIS_UNSUPPORTED_MEDIA : HRESULT = HRESULT::from_constant(0x80340019); // ERROR_NDIS_UNSUPPORTED_MEDIA
#[doc(hidden)] pub const NDIS_GROUP_ADDRESS_IN_USE : HRESULT = HRESULT::from_constant(0x8034001A); // ERROR_NDIS_GROUP_ADDRESS_IN_USE
#[doc(hidden)] pub const NDIS_FILE_NOT_FOUND : HRESULT = HRESULT::from_constant(0x8034001B); // ERROR_NDIS_FILE_NOT_FOUND
#[doc(hidden)] pub const NDIS_ERROR_READING_FILE : HRESULT = HRESULT::from_constant(0x8034001C); // ERROR_NDIS_ERROR_READING_FILE
#[doc(hidden)] pub const NDIS_ALREADY_MAPPED : HRESULT = HRESULT::from_constant(0x8034001D); // ERROR_NDIS_ALREADY_MAPPED
#[doc(hidden)] pub const NDIS_RESOURCE_CONFLICT : HRESULT = HRESULT::from_constant(0x8034001E); // ERROR_NDIS_RESOURCE_CONFLICT
#[doc(hidden)] pub const NDIS_MEDIA_DISCONNECTED : HRESULT = HRESULT::from_constant(0x8034001F); // ERROR_NDIS_MEDIA_DISCONNECTED
#[doc(hidden)] pub const NDIS_INVALID_ADDRESS : HRESULT = HRESULT::from_constant(0x80340022); // ERROR_NDIS_INVALID_ADDRESS
#[doc(hidden)] pub const NDIS_INVALID_DEVICE_REQUEST : HRESULT = HRESULT::from_constant(0x80340010); // ERROR_NDIS_INVALID_DEVICE_REQUEST
#[doc(hidden)] pub const NDIS_PAUSED : HRESULT = HRESULT::from_constant(0x8034002A); // ERROR_NDIS_PAUSED
#[doc(hidden)] pub const NDIS_INTERFACE_NOT_FOUND : HRESULT = HRESULT::from_constant(0x8034002B); // ERROR_NDIS_INTERFACE_NOT_FOUND
#[doc(hidden)] pub const NDIS_UNSUPPORTED_REVISION : HRESULT = HRESULT::from_constant(0x8034002C); // ERROR_NDIS_UNSUPPORTED_REVISION
#[doc(hidden)] pub const NDIS_INVALID_PORT : HRESULT = HRESULT::from_constant(0x8034002D); // ERROR_NDIS_INVALID_PORT
#[doc(hidden)] pub const NDIS_INVALID_PORT_STATE : HRESULT = HRESULT::from_constant(0x8034002E); // ERROR_NDIS_INVALID_PORT_STATE
#[doc(hidden)] pub const NDIS_LOW_POWER_STATE : HRESULT = HRESULT::from_constant(0x8034002F); // ERROR_NDIS_LOW_POWER_STATE
#[doc(hidden)] pub const NDIS_REINIT_REQUIRED : HRESULT = HRESULT::from_constant(0x80340030); // ERROR_NDIS_REINIT_REQUIRED
#[doc(hidden)] pub const NDIS_NO_QUEUES : HRESULT = HRESULT::from_constant(0x80340031); // ERROR_NDIS_NO_QUEUES
#[doc(hidden)] pub const NDIS_DOT11_AUTO_CONFIG_ENABLED : HRESULT = HRESULT::from_constant(0x80342000); // ERROR_NDIS_DOT11_AUTO_CONFIG_ENABLED
#[doc(hidden)] pub const NDIS_DOT11_MEDIA_IN_USE : HRESULT = HRESULT::from_constant(0x80342001); // ERROR_NDIS_DOT11_MEDIA_IN_USE
#[doc(hidden)] pub const NDIS_DOT11_POWER_STATE_INVALID : HRESULT = HRESULT::from_constant(0x80342002); // ERROR_NDIS_DOT11_POWER_STATE_INVALID
#[doc(hidden)] pub const NDIS_PM_WOL_PATTERN_LIST_FULL : HRESULT = HRESULT::from_constant(0x80342003); // ERROR_NDIS_PM_WOL_PATTERN_LIST_FULL
#[doc(hidden)] pub const NDIS_PM_PROTOCOL_OFFLOAD_LIST_FULL : HRESULT = HRESULT::from_constant(0x80342004); // ERROR_NDIS_PM_PROTOCOL_OFFLOAD_LIST_FULL
#[doc(hidden)] pub const NDIS_DOT11_AP_CHANNEL_CURRENTLY_NOT_AVAILABLE : HRESULT = HRESULT::from_constant(0x80342005); // ERROR_NDIS_DOT11_AP_CHANNEL_CURRENTLY_NOT_AVAILABLE
#[doc(hidden)] pub const NDIS_DOT11_AP_BAND_CURRENTLY_NOT_AVAILABLE : HRESULT = HRESULT::from_constant(0x80342006); // ERROR_NDIS_DOT11_AP_BAND_CURRENTLY_NOT_AVAILABLE
#[doc(hidden)] pub const NDIS_DOT11_AP_CHANNEL_NOT_ALLOWED : HRESULT = HRESULT::from_constant(0x80342007); // ERROR_NDIS_DOT11_AP_CHANNEL_NOT_ALLOWED
#[doc(hidden)] pub const NDIS_DOT11_AP_BAND_NOT_ALLOWED : HRESULT = HRESULT::from_constant(0x80342008); // ERROR_NDIS_DOT11_AP_BAND_NOT_ALLOWED
#[doc(hidden)] pub const NDIS_INDICATION_REQUIRED : HRESULT = HRESULT::from_constant(0x00340001); // ERROR_NDIS_INDICATION_REQUIRED
#[doc(hidden)] pub const NDIS_OFFLOAD_POLICY : HRESULT = HRESULT::from_constant(0xC034100F); // ERROR_NDIS_OFFLOAD_POLICY
#[doc(hidden)] pub const NDIS_OFFLOAD_CONNECTION_REJECTED : HRESULT = HRESULT::from_constant(0xC0341012); // ERROR_NDIS_OFFLOAD_CONNECTION_REJECTED
#[doc(hidden)] pub const NDIS_OFFLOAD_PATH_REJECTED : HRESULT = HRESULT::from_constant(0xC0341013); // ERROR_NDIS_OFFLOAD_PATH_REJECTED

/// The hypervisor does not support the operation because the specified hypercall code is not supported.
pub const HV_INVALID_HYPERCALL_CODE : HRESULT = HRESULT::from_constant(0xC0350002); // ERROR_HV_INVALID_HYPERCALL_CODE

/// The hypervisor does not support the operation because the encoding for the hypercall input register is not supported.
pub const HV_INVALID_HYPERCALL_INPUT : HRESULT = HRESULT::from_constant(0xC0350003); // ERROR_HV_INVALID_HYPERCALL_INPUT

/// The hypervisor could not perform the operation because a parameter has an invalid alignment.
pub const HV_INVALID_ALIGNMENT : HRESULT = HRESULT::from_constant(0xC0350004); // ERROR_HV_INVALID_ALIGNMENT

/// The hypervisor could not perform the operation because an invalid parameter was specified.
pub const HV_INVALID_PARAMETER : HRESULT = HRESULT::from_constant(0xC0350005); // ERROR_HV_INVALID_PARAMETER

/// Access to the specified object was denied.
pub const HV_ACCESS_DENIED : HRESULT = HRESULT::from_constant(0xC0350006); // ERROR_HV_ACCESS_DENIED

/// The hypervisor could not perform the operation because the partition is entering or in an invalid state.
pub const HV_INVALID_PARTITION_STATE : HRESULT = HRESULT::from_constant(0xC0350007); // ERROR_HV_INVALID_PARTITION_STATE

/// The operation is not allowed in the current state.
pub const HV_OPERATION_DENIED : HRESULT = HRESULT::from_constant(0xC0350008); // ERROR_HV_OPERATION_DENIED

/// The hypervisor does not recognize the specified partition property.
pub const HV_UNKNOWN_PROPERTY : HRESULT = HRESULT::from_constant(0xC0350009); // ERROR_HV_UNKNOWN_PROPERTY

/// The specified value of a partition property is out of range or violates an invariant.
pub const HV_PROPERTY_VALUE_OUT_OF_RANGE : HRESULT = HRESULT::from_constant(0xC035000A); // ERROR_HV_PROPERTY_VALUE_OUT_OF_RANGE

/// There is not enough memory in the hypervisor pool to complete the operation.
pub const HV_INSUFFICIENT_MEMORY : HRESULT = HRESULT::from_constant(0xC035000B); // ERROR_HV_INSUFFICIENT_MEMORY

/// The maximum partition depth has been exceeded for the partition hierarchy.
pub const HV_PARTITION_TOO_DEEP : HRESULT = HRESULT::from_constant(0xC035000C); // ERROR_HV_PARTITION_TOO_DEEP

/// A partition with the specified partition Id does not exist.
pub const HV_INVALID_PARTITION_ID : HRESULT = HRESULT::from_constant(0xC035000D); // ERROR_HV_INVALID_PARTITION_ID

/// The hypervisor could not perform the operation because the specified VP index is invalid.
pub const HV_INVALID_VP_INDEX : HRESULT = HRESULT::from_constant(0xC035000E); // ERROR_HV_INVALID_VP_INDEX

/// The hypervisor could not perform the operation because the specified port identifier is invalid.
pub const HV_INVALID_PORT_ID : HRESULT = HRESULT::from_constant(0xC0350011); // ERROR_HV_INVALID_PORT_ID

/// The hypervisor could not perform the operation because the specified connection identifier is invalid.
pub const HV_INVALID_CONNECTION_ID : HRESULT = HRESULT::from_constant(0xC0350012); // ERROR_HV_INVALID_CONNECTION_ID

/// Not enough buffers were supplied to send a message.
pub const HV_INSUFFICIENT_BUFFERS : HRESULT = HRESULT::from_constant(0xC0350013); // ERROR_HV_INSUFFICIENT_BUFFERS

/// The previous virtual interrupt has not been acknowledged.
pub const HV_NOT_ACKNOWLEDGED : HRESULT = HRESULT::from_constant(0xC0350014); // ERROR_HV_NOT_ACKNOWLEDGED

/// A virtual processor is not in the correct state for the indicated operation.
pub const HV_INVALID_VP_STATE : HRESULT = HRESULT::from_constant(0xC0350015); // ERROR_HV_INVALID_VP_STATE

/// The previous virtual interrupt has already been acknowledged.
pub const HV_ACKNOWLEDGED : HRESULT = HRESULT::from_constant(0xC0350016); // ERROR_HV_ACKNOWLEDGED

/// The indicated partition is not in a valid state for saving or restoring.
pub const HV_INVALID_SAVE_RESTORE_STATE : HRESULT = HRESULT::from_constant(0xC0350017); // ERROR_HV_INVALID_SAVE_RESTORE_STATE

/// The hypervisor could not complete the operation because a required feature of the synthetic interrupt controller (SynIC) was disabled.
pub const HV_INVALID_SYNIC_STATE : HRESULT = HRESULT::from_constant(0xC0350018); // ERROR_HV_INVALID_SYNIC_STATE

/// The hypervisor could not perform the operation because the object or value was either already in use or being used for a purpose that would not permit completing the operation.
pub const HV_OBJECT_IN_USE : HRESULT = HRESULT::from_constant(0xC0350019); // ERROR_HV_OBJECT_IN_USE

/// The proximity domain information is invalid.
pub const HV_INVALID_PROXIMITY_DOMAIN_INFO : HRESULT = HRESULT::from_constant(0xC035001A); // ERROR_HV_INVALID_PROXIMITY_DOMAIN_INFO

/// An attempt to retrieve debugging data failed because none was available.
pub const HV_NO_DATA : HRESULT = HRESULT::from_constant(0xC035001B); // ERROR_HV_NO_DATA

/// The physical connection being used for debugging has not recorded any receive activity since the last operation.
pub const HV_INACTIVE : HRESULT = HRESULT::from_constant(0xC035001C); // ERROR_HV_INACTIVE

/// There are not enough resources to complete the operation.
pub const HV_NO_RESOURCES : HRESULT = HRESULT::from_constant(0xC035001D); // ERROR_HV_NO_RESOURCES

/// A hypervisor feature is not available to the user.
pub const HV_FEATURE_UNAVAILABLE : HRESULT = HRESULT::from_constant(0xC035001E); // ERROR_HV_FEATURE_UNAVAILABLE

/// The specified buffer was too small to contain all of the requested data.
pub const HV_INSUFFICIENT_BUFFER : HRESULT = HRESULT::from_constant(0xC0350033); // ERROR_HV_INSUFFICIENT_BUFFER

/// The maximum number of domains supported by the platform I/O remapping hardware is currently in use. No domains are available to assign this device to this partition.
pub const HV_INSUFFICIENT_DEVICE_DOMAINS : HRESULT = HRESULT::from_constant(0xC0350038); // ERROR_HV_INSUFFICIENT_DEVICE_DOMAINS

/// Validation of CPUID data of the processor failed.
pub const HV_CPUID_FEATURE_VALIDATION : HRESULT = HRESULT::from_constant(0xC035003C); // ERROR_HV_CPUID_FEATURE_VALIDATION

/// Validation of XSAVE CPUID data of the processor failed.
pub const HV_CPUID_XSAVE_FEATURE_VALIDATION : HRESULT = HRESULT::from_constant(0xC035003D); // ERROR_HV_CPUID_XSAVE_FEATURE_VALIDATION

/// Processor did not respond within the timeout period.
pub const HV_PROCESSOR_STARTUP_TIMEOUT : HRESULT = HRESULT::from_constant(0xC035003E); // ERROR_HV_PROCESSOR_STARTUP_TIMEOUT

/// SMX has been enabled in the BIOS.
pub const HV_SMX_ENABLED : HRESULT = HRESULT::from_constant(0xC035003F); // ERROR_HV_SMX_ENABLED

/// The hypervisor could not perform the operation because the specified LP index is invalid.
pub const HV_INVALID_LP_INDEX : HRESULT = HRESULT::from_constant(0xC0350041); // ERROR_HV_INVALID_LP_INDEX

/// The supplied register value is invalid.
pub const HV_INVALID_REGISTER_VALUE : HRESULT = HRESULT::from_constant(0xC0350050); // ERROR_HV_INVALID_REGISTER_VALUE

/// The supplied virtual trust level is not in the correct state to perform the requested operation.
pub const HV_INVALID_VTL_STATE : HRESULT = HRESULT::from_constant(0xC0350051); // ERROR_HV_INVALID_VTL_STATE

/// No execute feature (NX) is not present or not enabled in the BIOS.
pub const HV_NX_NOT_DETECTED : HRESULT = HRESULT::from_constant(0xC0350055); // ERROR_HV_NX_NOT_DETECTED

/// The supplied device ID is invalid.
pub const HV_INVALID_DEVICE_ID : HRESULT = HRESULT::from_constant(0xC0350057); // ERROR_HV_INVALID_DEVICE_ID

/// The operation is not allowed in the current device state.
pub const HV_INVALID_DEVICE_STATE : HRESULT = HRESULT::from_constant(0xC0350058); // ERROR_HV_INVALID_DEVICE_STATE

/// The device had pending page requests which were discarded.
pub const HV_PENDING_PAGE_REQUESTS : HRESULT = HRESULT::from_constant(0x00350059); // ERROR_HV_PENDING_PAGE_REQUESTS

/// The supplied page request specifies a memory access that the guest does not have permissions to perform.
pub const HV_PAGE_REQUEST_INVALID : HRESULT = HRESULT::from_constant(0xC0350060); // ERROR_HV_PAGE_REQUEST_INVALID

/// A CPU group with the specified CPU group Id does not exist.
pub const HV_INVALID_CPU_GROUP_ID : HRESULT = HRESULT::from_constant(0xC035006F); // ERROR_HV_INVALID_CPU_GROUP_ID

/// The hypervisor could not perform the operation because the CPU group is entering or in an invalid state.
pub const HV_INVALID_CPU_GROUP_STATE : HRESULT = HRESULT::from_constant(0xC0350070); // ERROR_HV_INVALID_CPU_GROUP_STATE

/// The requested operation failed.
pub const HV_OPERATION_FAILED : HRESULT = HRESULT::from_constant(0xC0350071); // ERROR_HV_OPERATION_FAILED

/// The hypervisor could not perform the operation because it is not allowed with nested virtualization active.
pub const HV_NOT_ALLOWED_WITH_NESTED_VIRT_ACTIVE : HRESULT = HRESULT::from_constant(0xC0350072); // ERROR_HV_NOT_ALLOWED_WITH_NESTED_VIRT_ACTIVE

/// There is not enough memory in the root partition's pool to complete the operation.
pub const HV_INSUFFICIENT_ROOT_MEMORY : HRESULT = HRESULT::from_constant(0xC0350073); // ERROR_HV_INSUFFICIENT_ROOT_MEMORY

/// The provided event log buffer was already marked as freed.
pub const HV_EVENT_BUFFER_ALREADY_FREED : HRESULT = HRESULT::from_constant(0xC0350074); // ERROR_HV_EVENT_BUFFER_ALREADY_FREED

/// There is not enough contiguous memory in the partition's pool to complete the operation.
pub const HV_INSUFFICIENT_CONTIGUOUS_MEMORY : HRESULT = HRESULT::from_constant(0xC0350075); // ERROR_HV_INSUFFICIENT_CONTIGUOUS_MEMORY

/// No hypervisor is present on this system.
pub const HV_NOT_PRESENT : HRESULT = HRESULT::from_constant(0xC0351000); // ERROR_HV_NOT_PRESENT

/// The handler for the virtualization infrastructure driver is already registered. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_DUPLICATE_HANDLER : HRESULT = HRESULT::from_constant(0xC0370001); // ERROR_VID_DUPLICATE_HANDLER

/// The number of registered handlers for the virtualization infrastructure driver exceeded the maximum. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_TOO_MANY_HANDLERS : HRESULT = HRESULT::from_constant(0xC0370002); // ERROR_VID_TOO_MANY_HANDLERS

/// The message queue for the virtualization infrastructure driver is full and cannot accept new messages. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_QUEUE_FULL : HRESULT = HRESULT::from_constant(0xC0370003); // ERROR_VID_QUEUE_FULL

/// No handler exists to handle the message for the virtualization infrastructure driver. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_HANDLER_NOT_PRESENT : HRESULT = HRESULT::from_constant(0xC0370004); // ERROR_VID_HANDLER_NOT_PRESENT

/// The name of the partition or message queue for the virtualization infrastructure driver is invalid. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_INVALID_OBJECT_NAME : HRESULT = HRESULT::from_constant(0xC0370005); // ERROR_VID_INVALID_OBJECT_NAME

/// The partition name of the virtualization infrastructure driver exceeds the maximum.
pub const VID_PARTITION_NAME_TOO_LONG : HRESULT = HRESULT::from_constant(0xC0370006); // ERROR_VID_PARTITION_NAME_TOO_LONG

/// The message queue name of the virtualization infrastructure driver exceeds the maximum.
pub const VID_MESSAGE_QUEUE_NAME_TOO_LONG : HRESULT = HRESULT::from_constant(0xC0370007); // ERROR_VID_MESSAGE_QUEUE_NAME_TOO_LONG

/// Cannot create the partition for the virtualization infrastructure driver because another partition with the same name already exists.
pub const VID_PARTITION_ALREADY_EXISTS : HRESULT = HRESULT::from_constant(0xC0370008); // ERROR_VID_PARTITION_ALREADY_EXISTS

/// The virtualization infrastructure driver has encountered an error. The requested partition does not exist. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_PARTITION_DOES_NOT_EXIST : HRESULT = HRESULT::from_constant(0xC0370009); // ERROR_VID_PARTITION_DOES_NOT_EXIST

/// The virtualization infrastructure driver has encountered an error. Could not find the requested partition. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_PARTITION_NAME_NOT_FOUND : HRESULT = HRESULT::from_constant(0xC037000A); // ERROR_VID_PARTITION_NAME_NOT_FOUND

/// A message queue with the same name already exists for the virtualization infrastructure driver.
pub const VID_MESSAGE_QUEUE_ALREADY_EXISTS : HRESULT = HRESULT::from_constant(0xC037000B); // ERROR_VID_MESSAGE_QUEUE_ALREADY_EXISTS

/// The memory block page for the virtualization infrastructure driver cannot be mapped because the page map limit has been reached. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_EXCEEDED_MBP_ENTRY_MAP_LIMIT : HRESULT = HRESULT::from_constant(0xC037000C); // ERROR_VID_EXCEEDED_MBP_ENTRY_MAP_LIMIT

/// The memory block for the virtualization infrastructure driver is still being used and cannot be destroyed.
pub const VID_MB_STILL_REFERENCED : HRESULT = HRESULT::from_constant(0xC037000D); // ERROR_VID_MB_STILL_REFERENCED

/// Cannot unlock the page array for the guest operating system memory address because it does not match a previous lock request. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_CHILD_GPA_PAGE_SET_CORRUPTED : HRESULT = HRESULT::from_constant(0xC037000E); // ERROR_VID_CHILD_GPA_PAGE_SET_CORRUPTED

/// The non-uniform memory access (NUMA) node settings do not match the system NUMA topology. In order to start the virtual machine, you will need to modify the NUMA configuration.
pub const VID_INVALID_NUMA_SETTINGS : HRESULT = HRESULT::from_constant(0xC037000F); // ERROR_VID_INVALID_NUMA_SETTINGS

/// The non-uniform memory access (NUMA) node index does not match a valid index in the system NUMA topology.
pub const VID_INVALID_NUMA_NODE_INDEX : HRESULT = HRESULT::from_constant(0xC0370010); // ERROR_VID_INVALID_NUMA_NODE_INDEX

/// The memory block for the virtualization infrastructure driver is already associated with a message queue.
pub const VID_NOTIFICATION_QUEUE_ALREADY_ASSOCIATED : HRESULT = HRESULT::from_constant(0xC0370011); // ERROR_VID_NOTIFICATION_QUEUE_ALREADY_ASSOCIATED

/// The handle is not a valid memory block handle for the virtualization infrastructure driver.
pub const VID_INVALID_MEMORY_BLOCK_HANDLE : HRESULT = HRESULT::from_constant(0xC0370012); // ERROR_VID_INVALID_MEMORY_BLOCK_HANDLE

/// The request exceeded the memory block page limit for the virtualization infrastructure driver. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_PAGE_RANGE_OVERFLOW : HRESULT = HRESULT::from_constant(0xC0370013); // ERROR_VID_PAGE_RANGE_OVERFLOW

/// The handle is not a valid message queue handle for the virtualization infrastructure driver.
pub const VID_INVALID_MESSAGE_QUEUE_HANDLE : HRESULT = HRESULT::from_constant(0xC0370014); // ERROR_VID_INVALID_MESSAGE_QUEUE_HANDLE

/// The handle is not a valid page range handle for the virtualization infrastructure driver.
pub const VID_INVALID_GPA_RANGE_HANDLE : HRESULT = HRESULT::from_constant(0xC0370015); // ERROR_VID_INVALID_GPA_RANGE_HANDLE

/// Cannot install client notifications because no message queue for the virtualization infrastructure driver is associated with the memory block.
pub const VID_NO_MEMORY_BLOCK_NOTIFICATION_QUEUE : HRESULT = HRESULT::from_constant(0xC0370016); // ERROR_VID_NO_MEMORY_BLOCK_NOTIFICATION_QUEUE

/// The request to lock or map a memory block page failed because the virtualization infrastructure driver memory block limit has been reached. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_MEMORY_BLOCK_LOCK_COUNT_EXCEEDED : HRESULT = HRESULT::from_constant(0xC0370017); // ERROR_VID_MEMORY_BLOCK_LOCK_COUNT_EXCEEDED

/// The handle is not a valid parent partition mapping handle for the virtualization infrastructure driver.
pub const VID_INVALID_PPM_HANDLE : HRESULT = HRESULT::from_constant(0xC0370018); // ERROR_VID_INVALID_PPM_HANDLE

/// Notifications cannot be created on the memory block because it is use.
pub const VID_MBPS_ARE_LOCKED : HRESULT = HRESULT::from_constant(0xC0370019); // ERROR_VID_MBPS_ARE_LOCKED

/// The message queue for the virtualization infrastructure driver has been closed. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_MESSAGE_QUEUE_CLOSED : HRESULT = HRESULT::from_constant(0xC037001A); // ERROR_VID_MESSAGE_QUEUE_CLOSED

/// Cannot add a virtual processor to the partition because the maximum has been reached.
pub const VID_VIRTUAL_PROCESSOR_LIMIT_EXCEEDED : HRESULT = HRESULT::from_constant(0xC037001B); // ERROR_VID_VIRTUAL_PROCESSOR_LIMIT_EXCEEDED

/// Cannot stop the virtual processor immediately because of a pending intercept.
pub const VID_STOP_PENDING : HRESULT = HRESULT::from_constant(0xC037001C); // ERROR_VID_STOP_PENDING

/// Invalid state for the virtual processor. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_INVALID_PROCESSOR_STATE : HRESULT = HRESULT::from_constant(0xC037001D); // ERROR_VID_INVALID_PROCESSOR_STATE

/// The maximum number of kernel mode clients for the virtualization infrastructure driver has been reached. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_EXCEEDED_KM_CONTEXT_COUNT_LIMIT : HRESULT = HRESULT::from_constant(0xC037001E); // ERROR_VID_EXCEEDED_KM_CONTEXT_COUNT_LIMIT

/// This kernel mode interface for the virtualization infrastructure driver has already been initialized. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_KM_INTERFACE_ALREADY_INITIALIZED : HRESULT = HRESULT::from_constant(0xC037001F); // ERROR_VID_KM_INTERFACE_ALREADY_INITIALIZED

/// Cannot set or reset the memory block property more than once for the virtualization infrastructure driver. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_MB_PROPERTY_ALREADY_SET_RESET : HRESULT = HRESULT::from_constant(0xC0370020); // ERROR_VID_MB_PROPERTY_ALREADY_SET_RESET

/// The memory mapped I/O for this page range no longer exists. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_MMIO_RANGE_DESTROYED : HRESULT = HRESULT::from_constant(0xC0370021); // ERROR_VID_MMIO_RANGE_DESTROYED

/// The lock or unlock request uses an invalid guest operating system memory address. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_INVALID_CHILD_GPA_PAGE_SET : HRESULT = HRESULT::from_constant(0xC0370022); // ERROR_VID_INVALID_CHILD_GPA_PAGE_SET

/// Cannot destroy or reuse the reserve page set for the virtualization infrastructure driver because it is in use. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_RESERVE_PAGE_SET_IS_BEING_USED : HRESULT = HRESULT::from_constant(0xC0370023); // ERROR_VID_RESERVE_PAGE_SET_IS_BEING_USED

/// The reserve page set for the virtualization infrastructure driver is too small to use in the lock request. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_RESERVE_PAGE_SET_TOO_SMALL : HRESULT = HRESULT::from_constant(0xC0370024); // ERROR_VID_RESERVE_PAGE_SET_TOO_SMALL

/// Cannot lock or map the memory block page for the virtualization infrastructure driver because it has already been locked using a reserve page set page. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_MBP_ALREADY_LOCKED_USING_RESERVED_PAGE : HRESULT = HRESULT::from_constant(0xC0370025); // ERROR_VID_MBP_ALREADY_LOCKED_USING_RESERVED_PAGE

/// Cannot create the memory block for the virtualization infrastructure driver because the requested number of pages exceeded the limit. Restarting the virtual machine may fix the problem. If the problem persists, try restarting the physical computer.
pub const VID_MBP_COUNT_EXCEEDED_LIMIT : HRESULT = HRESULT::from_constant(0xC0370026); // ERROR_VID_MBP_COUNT_EXCEEDED_LIMIT

/// Cannot restore this virtual machine because the saved state data cannot be read. Delete the saved state data and then try to start the virtual machine.
pub const VID_SAVED_STATE_CORRUPT : HRESULT = HRESULT::from_constant(0xC0370027); // ERROR_VID_SAVED_STATE_CORRUPT

/// Cannot restore this virtual machine because an item read from the saved state data is not recognized. Delete the saved state data and then try to start the virtual machine.
pub const VID_SAVED_STATE_UNRECOGNIZED_ITEM : HRESULT = HRESULT::from_constant(0xC0370028); // ERROR_VID_SAVED_STATE_UNRECOGNIZED_ITEM

/// Cannot restore this virtual machine to the saved state because of hypervisor incompatibility. Delete the saved state data and then try to start the virtual machine.
pub const VID_SAVED_STATE_INCOMPATIBLE : HRESULT = HRESULT::from_constant(0xC0370029); // ERROR_VID_SAVED_STATE_INCOMPATIBLE

/// The specified VTL does not have the permission to access the resource.
pub const VID_VTL_ACCESS_DENIED : HRESULT = HRESULT::from_constant(0xC037002A); // ERROR_VID_VTL_ACCESS_DENIED

/// The virtual machine or container exited unexpectedly while starting.
pub const VMCOMPUTE_TERMINATED_DURING_START : HRESULT = HRESULT::from_constant(0xC0370100); // ERROR_VMCOMPUTE_TERMINATED_DURING_START

/// The container operating system does not match the host operating system.
pub const VMCOMPUTE_IMAGE_MISMATCH : HRESULT = HRESULT::from_constant(0xC0370101); // ERROR_VMCOMPUTE_IMAGE_MISMATCH

/// The virtual machine could not be started because a required feature is not installed.
pub const VMCOMPUTE_HYPERV_NOT_INSTALLED : HRESULT = HRESULT::from_constant(0xC0370102); // ERROR_VMCOMPUTE_HYPERV_NOT_INSTALLED

/// The call to start an asynchronous operation succeeded and the operation is performed in the background.
pub const VMCOMPUTE_OPERATION_PENDING : HRESULT = HRESULT::from_constant(0xC0370103); // ERROR_VMCOMPUTE_OPERATION_PENDING

/// The supported number of notification callbacks has been exceeded.
pub const VMCOMPUTE_TOO_MANY_NOTIFICATIONS : HRESULT = HRESULT::from_constant(0xC0370104); // ERROR_VMCOMPUTE_TOO_MANY_NOTIFICATIONS

/// The requested virtual machine or container operation is not valid in the current state.
pub const VMCOMPUTE_INVALID_STATE : HRESULT = HRESULT::from_constant(0xC0370105); // ERROR_VMCOMPUTE_INVALID_STATE

/// The virtual machine or container exited unexpectedly.
pub const VMCOMPUTE_UNEXPECTED_EXIT : HRESULT = HRESULT::from_constant(0xC0370106); // ERROR_VMCOMPUTE_UNEXPECTED_EXIT

/// The virtual machine or container was forcefully exited.
pub const VMCOMPUTE_TERMINATED : HRESULT = HRESULT::from_constant(0xC0370107); // ERROR_VMCOMPUTE_TERMINATED

/// A connection could not be established with the container or virtual machine.
pub const VMCOMPUTE_CONNECT_FAILED : HRESULT = HRESULT::from_constant(0xC0370108); // ERROR_VMCOMPUTE_CONNECT_FAILED

/// The operation timed out because a response was not received from the virtual machine or container.
pub const VMCOMPUTE_TIMEOUT : HRESULT = HRESULT::from_constant(0xC0370109); // ERROR_VMCOMPUTE_TIMEOUT

/// The connection with the virtual machine or container was closed.
pub const VMCOMPUTE_CONNECTION_CLOSED : HRESULT = HRESULT::from_constant(0xC037010A); // ERROR_VMCOMPUTE_CONNECTION_CLOSED

/// An unknown internal message was received by the virtual machine or container.
pub const VMCOMPUTE_UNKNOWN_MESSAGE : HRESULT = HRESULT::from_constant(0xC037010B); // ERROR_VMCOMPUTE_UNKNOWN_MESSAGE

/// The virtual machine or container does not support an available version of the communication protocol with the host.
pub const VMCOMPUTE_UNSUPPORTED_PROTOCOL_VERSION : HRESULT = HRESULT::from_constant(0xC037010C); // ERROR_VMCOMPUTE_UNSUPPORTED_PROTOCOL_VERSION

/// The virtual machine or container JSON document is invalid.
pub const VMCOMPUTE_INVALID_JSON : HRESULT = HRESULT::from_constant(0xC037010D); // ERROR_VMCOMPUTE_INVALID_JSON

/// A virtual machine or container with the specified identifier does not exist.
pub const VMCOMPUTE_SYSTEM_NOT_FOUND : HRESULT = HRESULT::from_constant(0xC037010E); // ERROR_VMCOMPUTE_SYSTEM_NOT_FOUND

/// A virtual machine or container with the specified identifier already exists.
pub const VMCOMPUTE_SYSTEM_ALREADY_EXISTS : HRESULT = HRESULT::from_constant(0xC037010F); // ERROR_VMCOMPUTE_SYSTEM_ALREADY_EXISTS

/// The virtual machine or container with the specified identifier is not running.
pub const VMCOMPUTE_SYSTEM_ALREADY_STOPPED : HRESULT = HRESULT::from_constant(0xC0370110); // ERROR_VMCOMPUTE_SYSTEM_ALREADY_STOPPED

/// A communication protocol error has occurred between the virtual machine or container and the host.
pub const VMCOMPUTE_PROTOCOL_ERROR : HRESULT = HRESULT::from_constant(0xC0370111); // ERROR_VMCOMPUTE_PROTOCOL_ERROR

/// The container image contains a layer with an unrecognized format.
pub const VMCOMPUTE_INVALID_LAYER : HRESULT = HRESULT::from_constant(0xC0370112); // ERROR_VMCOMPUTE_INVALID_LAYER
...
pub const VMCOMPUTE_WINDOWS_INSIDER_REQUIRED : HRESULT = HRESULT::from_constant(0xC0370113); // ERROR_VMCOMPUTE_WINDOWS_INSIDER_REQUIRED

/// A virtual switch with the given name was not found.
pub const VNET_VIRTUAL_SWITCH_NAME_NOT_FOUND : HRESULT = HRESULT::from_constant(0xC0370200); // ERROR_VNET_VIRTUAL_SWITCH_NAME_NOT_FOUND

/// A virtual machine is running with its memory allocated across multiple NUMA nodes. This does not indicate a problem unless the performance of your virtual machine is unusually slow. If you are experiencing performance problems, you may need to modify the NUMA configuration.
pub const VID_REMOTE_NODE_PARENT_GPA_PAGES_USED : HRESULT = HRESULT::from_constant(0x80370001); // ERROR_VID_REMOTE_NODE_PARENT_GPA_PAGES_USED
...
pub const VSMB_SAVED_STATE_FILE_NOT_FOUND : HRESULT = HRESULT::from_constant(0xC0370400); // ERROR_VSMB_SAVED_STATE_FILE_NOT_FOUND
...
pub const VSMB_SAVED_STATE_CORRUPT : HRESULT = HRESULT::from_constant(0xC0370401); // ERROR_VSMB_SAVED_STATE_CORRUPT

/// The regeneration operation was not able to copy all data from the active plexes due to bad sectors.
pub const VOLMGR_INCOMPLETE_REGENERATION : HRESULT = HRESULT::from_constant(0x80380001); // ERROR_VOLMGR_INCOMPLETE_REGENERATION

/// One or more disks were not fully migrated to the target pack. They may or may not require reimport after fixing the hardware problems.
pub const VOLMGR_INCOMPLETE_DISK_MIGRATION : HRESULT = HRESULT::from_constant(0x80380002); // ERROR_VOLMGR_INCOMPLETE_DISK_MIGRATION

/// The configuration database is full.
pub const VOLMGR_DATABASE_FULL : HRESULT = HRESULT::from_constant(0xC0380001); // ERROR_VOLMGR_DATABASE_FULL

/// The configuration data on the disk is corrupted.
pub const VOLMGR_DISK_CONFIGURATION_CORRUPTED : HRESULT = HRESULT::from_constant(0xC0380002); // ERROR_VOLMGR_DISK_CONFIGURATION_CORRUPTED

/// The configuration on the disk is not insync with the in-memory configuration.
pub const VOLMGR_DISK_CONFIGURATION_NOT_IN_SYNC : HRESULT = HRESULT::from_constant(0xC0380003); // ERROR_VOLMGR_DISK_CONFIGURATION_NOT_IN_SYNC

/// A majority of disks failed to be updated with the new configuration.
pub const VOLMGR_PACK_CONFIG_UPDATE_FAILED : HRESULT = HRESULT::from_constant(0xC0380004); // ERROR_VOLMGR_PACK_CONFIG_UPDATE_FAILED

/// The disk contains non-simple volumes.
pub const VOLMGR_DISK_CONTAINS_NON_SIMPLE_VOLUME : HRESULT = HRESULT::from_constant(0xC0380005); // ERROR_VOLMGR_DISK_CONTAINS_NON_SIMPLE_VOLUME

/// The same disk was specified more than once in the migration list.
pub const VOLMGR_DISK_DUPLICATE : HRESULT = HRESULT::from_constant(0xC0380006); // ERROR_VOLMGR_DISK_DUPLICATE

/// The disk is already dynamic.
pub const VOLMGR_DISK_DYNAMIC : HRESULT = HRESULT::from_constant(0xC0380007); // ERROR_VOLMGR_DISK_DYNAMIC

/// The specified disk id is invalid. There are no disks with the specified disk id.
pub const VOLMGR_DISK_ID_INVALID : HRESULT = HRESULT::from_constant(0xC0380008); // ERROR_VOLMGR_DISK_ID_INVALID

/// The specified disk is an invalid disk. Operation cannot complete on an invalid disk.
pub const VOLMGR_DISK_INVALID : HRESULT = HRESULT::from_constant(0xC0380009); // ERROR_VOLMGR_DISK_INVALID

/// The specified disk(s) cannot be removed since it is the last remaining voter.
pub const VOLMGR_DISK_LAST_VOTER : HRESULT = HRESULT::from_constant(0xC038000A); // ERROR_VOLMGR_DISK_LAST_VOTER

/// The specified disk has an invalid disk layout.
pub const VOLMGR_DISK_LAYOUT_INVALID : HRESULT = HRESULT::from_constant(0xC038000B); // ERROR_VOLMGR_DISK_LAYOUT_INVALID

/// The disk layout contains non-basic partitions which appear after basic partitions. This is an invalid disk layout.
pub const VOLMGR_DISK_LAYOUT_NON_BASIC_BETWEEN_BASIC_PARTITIONS : HRESULT = HRESULT::from_constant(0xC038000C); // ERROR_VOLMGR_DISK_LAYOUT_NON_BASIC_BETWEEN_BASIC_PARTITIONS

/// The disk layout contains partitions which are not cylinder aligned.
pub const VOLMGR_DISK_LAYOUT_NOT_CYLINDER_ALIGNED : HRESULT = HRESULT::from_constant(0xC038000D); // ERROR_VOLMGR_DISK_LAYOUT_NOT_CYLINDER_ALIGNED

/// The disk layout contains partitions which are smaller than the minimum size.
pub const VOLMGR_DISK_LAYOUT_PARTITIONS_TOO_SMALL : HRESULT = HRESULT::from_constant(0xC038000E); // ERROR_VOLMGR_DISK_LAYOUT_PARTITIONS_TOO_SMALL

/// The disk layout contains primary partitions in between logical drives. This is an invalid disk layout.
pub const VOLMGR_DISK_LAYOUT_PRIMARY_BETWEEN_LOGICAL_PARTITIONS : HRESULT = HRESULT::from_constant(0xC038000F); // ERROR_VOLMGR_DISK_LAYOUT_PRIMARY_BETWEEN_LOGICAL_PARTITIONS

/// The disk layout contains more than the maximum number of supported partitions.
pub const VOLMGR_DISK_LAYOUT_TOO_MANY_PARTITIONS : HRESULT = HRESULT::from_constant(0xC0380010); // ERROR_VOLMGR_DISK_LAYOUT_TOO_MANY_PARTITIONS

/// The specified disk is missing. The operation cannot complete on a missing disk.
pub const VOLMGR_DISK_MISSING : HRESULT = HRESULT::from_constant(0xC0380011); // ERROR_VOLMGR_DISK_MISSING

/// The specified disk is not empty.
pub const VOLMGR_DISK_NOT_EMPTY : HRESULT = HRESULT::from_constant(0xC0380012); // ERROR_VOLMGR_DISK_NOT_EMPTY

/// There is not enough usable space for this operation.
pub const VOLMGR_DISK_NOT_ENOUGH_SPACE : HRESULT = HRESULT::from_constant(0xC0380013); // ERROR_VOLMGR_DISK_NOT_ENOUGH_SPACE

/// The force revectoring of bad sectors failed.
pub const VOLMGR_DISK_REVECTORING_FAILED : HRESULT = HRESULT::from_constant(0xC0380014); // ERROR_VOLMGR_DISK_REVECTORING_FAILED

/// The specified disk has an invalid sector size.
pub const VOLMGR_DISK_SECTOR_SIZE_INVALID : HRESULT = HRESULT::from_constant(0xC0380015); // ERROR_VOLMGR_DISK_SECTOR_SIZE_INVALID

/// The specified disk set contains volumes which exist on disks outside of the set.
pub const VOLMGR_DISK_SET_NOT_CONTAINED : HRESULT = HRESULT::from_constant(0xC0380016); // ERROR_VOLMGR_DISK_SET_NOT_CONTAINED

/// A disk in the volume layout provides extents to more than one member of a plex.
pub const VOLMGR_DISK_USED_BY_MULTIPLE_MEMBERS : HRESULT = HRESULT::from_constant(0xC0380017); // ERROR_VOLMGR_DISK_USED_BY_MULTIPLE_MEMBERS

/// A disk in the volume layout provides extents to more than one plex.
pub const VOLMGR_DISK_USED_BY_MULTIPLE_PLEXES : HRESULT = HRESULT::from_constant(0xC0380018); // ERROR_VOLMGR_DISK_USED_BY_MULTIPLE_PLEXES

/// Dynamic disks are not supported on this system.
pub const VOLMGR_DYNAMIC_DISK_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0380019); // ERROR_VOLMGR_DYNAMIC_DISK_NOT_SUPPORTED

/// The specified extent is already used by other volumes.
pub const VOLMGR_EXTENT_ALREADY_USED : HRESULT = HRESULT::from_constant(0xC038001A); // ERROR_VOLMGR_EXTENT_ALREADY_USED

/// The specified volume is retained and can only be extended into a contiguous extent. The specified extent to grow the volume is not contiguous with the specified volume.
pub const VOLMGR_EXTENT_NOT_CONTIGUOUS : HRESULT = HRESULT::from_constant(0xC038001B); // ERROR_VOLMGR_EXTENT_NOT_CONTIGUOUS

/// The specified volume extent is not within the public region of the disk.
pub const VOLMGR_EXTENT_NOT_IN_PUBLIC_REGION : HRESULT = HRESULT::from_constant(0xC038001C); // ERROR_VOLMGR_EXTENT_NOT_IN_PUBLIC_REGION

/// The specified volume extent is not sector aligned.
pub const VOLMGR_EXTENT_NOT_SECTOR_ALIGNED : HRESULT = HRESULT::from_constant(0xC038001D); // ERROR_VOLMGR_EXTENT_NOT_SECTOR_ALIGNED

/// The specified partition overlaps an EBR (the first track of an extended partition on an MBR disk).
pub const VOLMGR_EXTENT_OVERLAPS_EBR_PARTITION : HRESULT = HRESULT::from_constant(0xC038001E); // ERROR_VOLMGR_EXTENT_OVERLAPS_EBR_PARTITION

/// The specified extent lengths cannot be used to construct a volume with specified length.
pub const VOLMGR_EXTENT_VOLUME_LENGTHS_DO_NOT_MATCH : HRESULT = HRESULT::from_constant(0xC038001F); // ERROR_VOLMGR_EXTENT_VOLUME_LENGTHS_DO_NOT_MATCH

/// The system does not support fault tolerant volumes.
pub const VOLMGR_FAULT_TOLERANT_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC0380020); // ERROR_VOLMGR_FAULT_TOLERANT_NOT_SUPPORTED

/// The specified interleave length is invalid.
pub const VOLMGR_INTERLEAVE_LENGTH_INVALID : HRESULT = HRESULT::from_constant(0xC0380021); // ERROR_VOLMGR_INTERLEAVE_LENGTH_INVALID

/// There is already a maximum number of registered users.
pub const VOLMGR_MAXIMUM_REGISTERED_USERS : HRESULT = HRESULT::from_constant(0xC0380022); // ERROR_VOLMGR_MAXIMUM_REGISTERED_USERS

/// The specified member is already in-sync with the other active members. It does not need to be regenerated.
pub const VOLMGR_MEMBER_IN_SYNC : HRESULT = HRESULT::from_constant(0xC0380023); // ERROR_VOLMGR_MEMBER_IN_SYNC

/// The same member index was specified more than once.
pub const VOLMGR_MEMBER_INDEX_DUPLICATE : HRESULT = HRESULT::from_constant(0xC0380024); // ERROR_VOLMGR_MEMBER_INDEX_DUPLICATE

/// The specified member index is greater or equal than the number of members in the volume plex.
pub const VOLMGR_MEMBER_INDEX_INVALID : HRESULT = HRESULT::from_constant(0xC0380025); // ERROR_VOLMGR_MEMBER_INDEX_INVALID

/// The specified member is missing. It cannot be regenerated.
pub const VOLMGR_MEMBER_MISSING : HRESULT = HRESULT::from_constant(0xC0380026); // ERROR_VOLMGR_MEMBER_MISSING

/// The specified member is not detached. Cannot replace a member which is not detached.
pub const VOLMGR_MEMBER_NOT_DETACHED : HRESULT = HRESULT::from_constant(0xC0380027); // ERROR_VOLMGR_MEMBER_NOT_DETACHED

/// The specified member is already regenerating.
pub const VOLMGR_MEMBER_REGENERATING : HRESULT = HRESULT::from_constant(0xC0380028); // ERROR_VOLMGR_MEMBER_REGENERATING

/// All disks belonging to the pack failed.
pub const VOLMGR_ALL_DISKS_FAILED : HRESULT = HRESULT::from_constant(0xC0380029); // ERROR_VOLMGR_ALL_DISKS_FAILED

/// There are currently no registered users for notifications. The task number is irrelevant unless there are registered users.
pub const VOLMGR_NO_REGISTERED_USERS : HRESULT = HRESULT::from_constant(0xC038002A); // ERROR_VOLMGR_NO_REGISTERED_USERS

/// The specified notification user does not exist. Failed to unregister user for notifications.
pub const VOLMGR_NO_SUCH_USER : HRESULT = HRESULT::from_constant(0xC038002B); // ERROR_VOLMGR_NO_SUCH_USER

/// The notifications have been reset. Notifications for the current user are invalid. Unregister and re-register for notifications.
pub const VOLMGR_NOTIFICATION_RESET : HRESULT = HRESULT::from_constant(0xC038002C); // ERROR_VOLMGR_NOTIFICATION_RESET

/// The specified number of members is invalid.
pub const VOLMGR_NUMBER_OF_MEMBERS_INVALID : HRESULT = HRESULT::from_constant(0xC038002D); // ERROR_VOLMGR_NUMBER_OF_MEMBERS_INVALID

/// The specified number of plexes is invalid.
pub const VOLMGR_NUMBER_OF_PLEXES_INVALID : HRESULT = HRESULT::from_constant(0xC038002E); // ERROR_VOLMGR_NUMBER_OF_PLEXES_INVALID

/// The specified source and target packs are identical.
pub const VOLMGR_PACK_DUPLICATE : HRESULT = HRESULT::from_constant(0xC038002F); // ERROR_VOLMGR_PACK_DUPLICATE

/// The specified pack id is invalid. There are no packs with the specified pack id.
pub const VOLMGR_PACK_ID_INVALID : HRESULT = HRESULT::from_constant(0xC0380030); // ERROR_VOLMGR_PACK_ID_INVALID

/// The specified pack is the invalid pack. The operation cannot complete with the invalid pack.
pub const VOLMGR_PACK_INVALID : HRESULT = HRESULT::from_constant(0xC0380031); // ERROR_VOLMGR_PACK_INVALID

/// The specified pack name is invalid.
pub const VOLMGR_PACK_NAME_INVALID : HRESULT = HRESULT::from_constant(0xC0380032); // ERROR_VOLMGR_PACK_NAME_INVALID

/// The specified pack is offline.
pub const VOLMGR_PACK_OFFLINE : HRESULT = HRESULT::from_constant(0xC0380033); // ERROR_VOLMGR_PACK_OFFLINE

/// The specified pack already has a quorum of healthy disks.
pub const VOLMGR_PACK_HAS_QUORUM : HRESULT = HRESULT::from_constant(0xC0380034); // ERROR_VOLMGR_PACK_HAS_QUORUM

/// The pack does not have a quorum of healthy disks.
pub const VOLMGR_PACK_WITHOUT_QUORUM : HRESULT = HRESULT::from_constant(0xC0380035); // ERROR_VOLMGR_PACK_WITHOUT_QUORUM

/// The specified disk has an unsupported partition style. Only MBR and GPT partition styles are supported.
pub const VOLMGR_PARTITION_STYLE_INVALID : HRESULT = HRESULT::from_constant(0xC0380036); // ERROR_VOLMGR_PARTITION_STYLE_INVALID

/// Failed to update the disk's partition layout.
pub const VOLMGR_PARTITION_UPDATE_FAILED : HRESULT = HRESULT::from_constant(0xC0380037); // ERROR_VOLMGR_PARTITION_UPDATE_FAILED

/// The specified plex is already in-sync with the other active plexes. It does not need to be regenerated.
pub const VOLMGR_PLEX_IN_SYNC : HRESULT = HRESULT::from_constant(0xC0380038); // ERROR_VOLMGR_PLEX_IN_SYNC

/// The same plex index was specified more than once.
pub const VOLMGR_PLEX_INDEX_DUPLICATE : HRESULT = HRESULT::from_constant(0xC0380039); // ERROR_VOLMGR_PLEX_INDEX_DUPLICATE

/// The specified plex index is greater or equal than the number of plexes in the volume.
pub const VOLMGR_PLEX_INDEX_INVALID : HRESULT = HRESULT::from_constant(0xC038003A); // ERROR_VOLMGR_PLEX_INDEX_INVALID

/// The specified plex is the last active plex in the volume. The plex cannot be removed or else the volume will go offline.
pub const VOLMGR_PLEX_LAST_ACTIVE : HRESULT = HRESULT::from_constant(0xC038003B); // ERROR_VOLMGR_PLEX_LAST_ACTIVE

/// The specified plex is missing.
pub const VOLMGR_PLEX_MISSING : HRESULT = HRESULT::from_constant(0xC038003C); // ERROR_VOLMGR_PLEX_MISSING

/// The specified plex is currently regenerating.
pub const VOLMGR_PLEX_REGENERATING : HRESULT = HRESULT::from_constant(0xC038003D); // ERROR_VOLMGR_PLEX_REGENERATING

/// The specified plex type is invalid.
pub const VOLMGR_PLEX_TYPE_INVALID : HRESULT = HRESULT::from_constant(0xC038003E); // ERROR_VOLMGR_PLEX_TYPE_INVALID

/// The operation is only supported on RAID-5 plexes.
pub const VOLMGR_PLEX_NOT_RAID5 : HRESULT = HRESULT::from_constant(0xC038003F); // ERROR_VOLMGR_PLEX_NOT_RAID5

/// The operation is only supported on simple plexes.
pub const VOLMGR_PLEX_NOT_SIMPLE : HRESULT = HRESULT::from_constant(0xC0380040); // ERROR_VOLMGR_PLEX_NOT_SIMPLE

/// The Size fields in the VM_VOLUME_LAYOUT input structure are incorrectly set.
pub const VOLMGR_STRUCTURE_SIZE_INVALID : HRESULT = HRESULT::from_constant(0xC0380041); // ERROR_VOLMGR_STRUCTURE_SIZE_INVALID

/// There is already a pending request for notifications. Wait for the existing request to return before requesting for more notifications.
pub const VOLMGR_TOO_MANY_NOTIFICATION_REQUESTS : HRESULT = HRESULT::from_constant(0xC0380042); // ERROR_VOLMGR_TOO_MANY_NOTIFICATION_REQUESTS

/// There is currently a transaction in process.
pub const VOLMGR_TRANSACTION_IN_PROGRESS : HRESULT = HRESULT::from_constant(0xC0380043); // ERROR_VOLMGR_TRANSACTION_IN_PROGRESS

/// An unexpected layout change occurred outside of the volume manager.
pub const VOLMGR_UNEXPECTED_DISK_LAYOUT_CHANGE : HRESULT = HRESULT::from_constant(0xC0380044); // ERROR_VOLMGR_UNEXPECTED_DISK_LAYOUT_CHANGE

/// The specified volume contains a missing disk.
pub const VOLMGR_VOLUME_CONTAINS_MISSING_DISK : HRESULT = HRESULT::from_constant(0xC0380045); // ERROR_VOLMGR_VOLUME_CONTAINS_MISSING_DISK

/// The specified volume id is invalid. There are no volumes with the specified volume id.
pub const VOLMGR_VOLUME_ID_INVALID : HRESULT = HRESULT::from_constant(0xC0380046); // ERROR_VOLMGR_VOLUME_ID_INVALID

/// The specified volume length is invalid.
pub const VOLMGR_VOLUME_LENGTH_INVALID : HRESULT = HRESULT::from_constant(0xC0380047); // ERROR_VOLMGR_VOLUME_LENGTH_INVALID

/// The specified size for the volume is not a multiple of the sector size.
pub const VOLMGR_VOLUME_LENGTH_NOT_SECTOR_SIZE_MULTIPLE : HRESULT = HRESULT::from_constant(0xC0380048); // ERROR_VOLMGR_VOLUME_LENGTH_NOT_SECTOR_SIZE_MULTIPLE

/// The operation is only supported on mirrored volumes.
pub const VOLMGR_VOLUME_NOT_MIRRORED : HRESULT = HRESULT::from_constant(0xC0380049); // ERROR_VOLMGR_VOLUME_NOT_MIRRORED

/// The specified volume does not have a retain partition.
pub const VOLMGR_VOLUME_NOT_RETAINED : HRESULT = HRESULT::from_constant(0xC038004A); // ERROR_VOLMGR_VOLUME_NOT_RETAINED

/// The specified volume is offline.
pub const VOLMGR_VOLUME_OFFLINE : HRESULT = HRESULT::from_constant(0xC038004B); // ERROR_VOLMGR_VOLUME_OFFLINE

/// The specified volume already has a retain partition.
pub const VOLMGR_VOLUME_RETAINED : HRESULT = HRESULT::from_constant(0xC038004C); // ERROR_VOLMGR_VOLUME_RETAINED

/// The specified number of extents is invalid.
pub const VOLMGR_NUMBER_OF_EXTENTS_INVALID : HRESULT = HRESULT::from_constant(0xC038004D); // ERROR_VOLMGR_NUMBER_OF_EXTENTS_INVALID

/// All disks participating to the volume must have the same sector size.
pub const VOLMGR_DIFFERENT_SECTOR_SIZE : HRESULT = HRESULT::from_constant(0xC038004E); // ERROR_VOLMGR_DIFFERENT_SECTOR_SIZE

/// The boot disk experienced failures.
pub const VOLMGR_BAD_BOOT_DISK : HRESULT = HRESULT::from_constant(0xC038004F); // ERROR_VOLMGR_BAD_BOOT_DISK

/// The configuration of the pack is offline.
pub const VOLMGR_PACK_CONFIG_OFFLINE : HRESULT = HRESULT::from_constant(0xC0380050); // ERROR_VOLMGR_PACK_CONFIG_OFFLINE

/// The configuration of the pack is online.
pub const VOLMGR_PACK_CONFIG_ONLINE : HRESULT = HRESULT::from_constant(0xC0380051); // ERROR_VOLMGR_PACK_CONFIG_ONLINE

/// The specified pack is not the primary pack.
pub const VOLMGR_NOT_PRIMARY_PACK : HRESULT = HRESULT::from_constant(0xC0380052); // ERROR_VOLMGR_NOT_PRIMARY_PACK

/// All disks failed to be updated with the new content of the log.
pub const VOLMGR_PACK_LOG_UPDATE_FAILED : HRESULT = HRESULT::from_constant(0xC0380053); // ERROR_VOLMGR_PACK_LOG_UPDATE_FAILED

/// The specified number of disks in a plex is invalid.
pub const VOLMGR_NUMBER_OF_DISKS_IN_PLEX_INVALID : HRESULT = HRESULT::from_constant(0xC0380054); // ERROR_VOLMGR_NUMBER_OF_DISKS_IN_PLEX_INVALID

/// The specified number of disks in a plex member is invalid.
pub const VOLMGR_NUMBER_OF_DISKS_IN_MEMBER_INVALID : HRESULT = HRESULT::from_constant(0xC0380055); // ERROR_VOLMGR_NUMBER_OF_DISKS_IN_MEMBER_INVALID

/// The operation is not supported on mirrored volumes.
pub const VOLMGR_VOLUME_MIRRORED : HRESULT = HRESULT::from_constant(0xC0380056); // ERROR_VOLMGR_VOLUME_MIRRORED

/// The operation is only supported on simple and spanned plexes.
pub const VOLMGR_PLEX_NOT_SIMPLE_SPANNED : HRESULT = HRESULT::from_constant(0xC0380057); // ERROR_VOLMGR_PLEX_NOT_SIMPLE_SPANNED

/// The pack has no valid log copies.
pub const VOLMGR_NO_VALID_LOG_COPIES : HRESULT = HRESULT::from_constant(0xC0380058); // ERROR_VOLMGR_NO_VALID_LOG_COPIES

/// A primary pack is already present.
pub const VOLMGR_PRIMARY_PACK_PRESENT : HRESULT = HRESULT::from_constant(0xC0380059); // ERROR_VOLMGR_PRIMARY_PACK_PRESENT

/// The specified number of disks is invalid.
pub const VOLMGR_NUMBER_OF_DISKS_INVALID : HRESULT = HRESULT::from_constant(0xC038005A); // ERROR_VOLMGR_NUMBER_OF_DISKS_INVALID

/// The system does not support mirrored volumes.
pub const VOLMGR_MIRROR_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC038005B); // ERROR_VOLMGR_MIRROR_NOT_SUPPORTED

/// The system does not support RAID-5 volumes.
pub const VOLMGR_RAID5_NOT_SUPPORTED : HRESULT = HRESULT::from_constant(0xC038005C); // ERROR_VOLMGR_RAID5_NOT_SUPPORTED

/// Some BCD entries were not imported correctly from the BCD store.
pub const BCD_NOT_ALL_ENTRIES_IMPORTED : HRESULT = HRESULT::from_constant(0x80390001); // ERROR_BCD_NOT_ALL_ENTRIES_IMPORTED

/// Entries enumerated have exceeded the allowed threshold.
pub const BCD_TOO_MANY_ELEMENTS : HRESULT = HRESULT::from_constant(0xC0390002); // ERROR_BCD_TOO_MANY_ELEMENTS

/// Some BCD entries were not synchronized correctly with the firmware.
pub const BCD_NOT_ALL_ENTRIES_SYNCHRONIZED : HRESULT = HRESULT::from_constant(0x80390003); // ERROR_BCD_NOT_ALL_ENTRIES_SYNCHRONIZED

#[doc(hidden)] pub const VHD_DRIVE_FOOTER_MISSING : HRESULT = HRESULT::from_constant(0xC03A0001); // ERROR_VHD_DRIVE_FOOTER_MISSING
#[doc(hidden)] pub const VHD_DRIVE_FOOTER_CHECKSUM_MISMATCH : HRESULT = HRESULT::from_constant(0xC03A0002); // ERROR_VHD_DRIVE_FOOTER_CHECKSUM_MISMATCH
#[doc(hidden)] pub const VHD_DRIVE_FOOTER_CORRUPT : HRESULT = HRESULT::from_constant(0xC03A0003); // ERROR_VHD_DRIVE_FOOTER_CORRUPT
#[doc(hidden)] pub const VHD_FORMAT_UNKNOWN : HRESULT = HRESULT::from_constant(0xC03A0004); // ERROR_VHD_FORMAT_UNKNOWN
#[doc(hidden)] pub const VHD_FORMAT_UNSUPPORTED_VERSION : HRESULT = HRESULT::from_constant(0xC03A0005); // ERROR_VHD_FORMAT_UNSUPPORTED_VERSION
#[doc(hidden)] pub const VHD_SPARSE_HEADER_CHECKSUM_MISMATCH : HRESULT = HRESULT::from_constant(0xC03A0006); // ERROR_VHD_SPARSE_HEADER_CHECKSUM_MISMATCH
#[doc(hidden)] pub const VHD_SPARSE_HEADER_UNSUPPORTED_VERSION : HRESULT = HRESULT::from_constant(0xC03A0007); // ERROR_VHD_SPARSE_HEADER_UNSUPPORTED_VERSION
#[doc(hidden)] pub const VHD_SPARSE_HEADER_CORRUPT : HRESULT = HRESULT::from_constant(0xC03A0008); // ERROR_VHD_SPARSE_HEADER_CORRUPT
#[doc(hidden)] pub const VHD_BLOCK_ALLOCATION_FAILURE : HRESULT = HRESULT::from_constant(0xC03A0009); // ERROR_VHD_BLOCK_ALLOCATION_FAILURE
#[doc(hidden)] pub const VHD_BLOCK_ALLOCATION_TABLE_CORRUPT : HRESULT = HRESULT::from_constant(0xC03A000A); // ERROR_VHD_BLOCK_ALLOCATION_TABLE_CORRUPT
#[doc(hidden)] pub const VHD_INVALID_BLOCK_SIZE : HRESULT = HRESULT::from_constant(0xC03A000B); // ERROR_VHD_INVALID_BLOCK_SIZE
#[doc(hidden)] pub const VHD_BITMAP_MISMATCH : HRESULT = HRESULT::from_constant(0xC03A000C); // ERROR_VHD_BITMAP_MISMATCH
#[doc(hidden)] pub const VHD_PARENT_VHD_NOT_FOUND : HRESULT = HRESULT::from_constant(0xC03A000D); // ERROR_VHD_PARENT_VHD_NOT_FOUND
#[doc(hidden)] pub const VHD_CHILD_PARENT_ID_MISMATCH : HRESULT = HRESULT::from_constant(0xC03A000E); // ERROR_VHD_CHILD_PARENT_ID_MISMATCH
#[doc(hidden)] pub const VHD_CHILD_PARENT_TIMESTAMP_MISMATCH : HRESULT = HRESULT::from_constant(0xC03A000F); // ERROR_VHD_CHILD_PARENT_TIMESTAMP_MISMATCH
#[doc(hidden)] pub const VHD_METADATA_READ_FAILURE : HRESULT = HRESULT::from_constant(0xC03A0010); // ERROR_VHD_METADATA_READ_FAILURE
#[doc(hidden)] pub const VHD_METADATA_WRITE_FAILURE : HRESULT = HRESULT::from_constant(0xC03A0011); // ERROR_VHD_METADATA_WRITE_FAILURE
#[doc(hidden)] pub const VHD_INVALID_SIZE : HRESULT = HRESULT::from_constant(0xC03A0012); // ERROR_VHD_INVALID_SIZE
#[doc(hidden)] pub const VHD_INVALID_FILE_SIZE : HRESULT = HRESULT::from_constant(0xC03A0013); // ERROR_VHD_INVALID_FILE_SIZE

/// A virtual disk support provider for the specified file was not found.
pub const VIRTDISK_PROVIDER_NOT_FOUND : HRESULT = HRESULT::from_constant(0xC03A0014); // ERROR_VIRTDISK_PROVIDER_NOT_FOUND

/// The specified disk is not a virtual disk.
pub const VIRTDISK_NOT_VIRTUAL_DISK : HRESULT = HRESULT::from_constant(0xC03A0015); // ERROR_VIRTDISK_NOT_VIRTUAL_DISK

#[doc(hidden)] pub const VHD_PARENT_VHD_ACCESS_DENIED : HRESULT = HRESULT::from_constant(0xC03A0016); // ERROR_VHD_PARENT_VHD_ACCESS_DENIED
#[doc(hidden)] pub const VHD_CHILD_PARENT_SIZE_MISMATCH : HRESULT = HRESULT::from_constant(0xC03A0017); // ERROR_VHD_CHILD_PARENT_SIZE_MISMATCH
#[doc(hidden)] pub const VHD_DIFFERENCING_CHAIN_CYCLE_DETECTED : HRESULT = HRESULT::from_constant(0xC03A0018); // ERROR_VHD_DIFFERENCING_CHAIN_CYCLE_DETECTED
#[doc(hidden)] pub const VHD_DIFFERENCING_CHAIN_ERROR_IN_PARENT : HRESULT = HRESULT::from_constant(0xC03A0019); // ERROR_VHD_DIFFERENCING_CHAIN_ERROR_IN_PARENT

/// The requested operation could not be completed due to a virtual disk system limitation.  Virtual hard disk files must be uncompressed and unencrypted and must not be sparse.
pub const VIRTUAL_DISK_LIMITATION : HRESULT = HRESULT::from_constant(0xC03A001A); // ERROR_VIRTUAL_DISK_LIMITATION

#[doc(hidden)] pub const VHD_INVALID_TYPE : HRESULT = HRESULT::from_constant(0xC03A001B); // ERROR_VHD_INVALID_TYPE
#[doc(hidden)] pub const VHD_INVALID_STATE : HRESULT = HRESULT::from_constant(0xC03A001C); // ERROR_VHD_INVALID_STATE

/// The sector size of the physical disk on which the virtual disk resides is not supported.
pub const VIRTDISK_UNSUPPORTED_DISK_SECTOR_SIZE : HRESULT = HRESULT::from_constant(0xC03A001D); // ERROR_VIRTDISK_UNSUPPORTED_DISK_SECTOR_SIZE

/// The disk is already owned by a different owner.
pub const VIRTDISK_DISK_ALREADY_OWNED : HRESULT = HRESULT::from_constant(0xC03A001E); // ERROR_VIRTDISK_DISK_ALREADY_OWNED

/// The disk must be offline or read-only.
pub const VIRTDISK_DISK_ONLINE_AND_WRITABLE : HRESULT = HRESULT::from_constant(0xC03A001F); // ERROR_VIRTDISK_DISK_ONLINE_AND_WRITABLE

/// Change Tracking is not initialized for this virtual disk.
pub const CTLOG_TRACKING_NOT_INITIALIZED : HRESULT = HRESULT::from_constant(0xC03A0020); // ERROR_CTLOG_TRACKING_NOT_INITIALIZED

/// Size of change tracking file exceeded the maximum size limit.
pub const CTLOG_LOGFILE_SIZE_EXCEEDED_MAXSIZE : HRESULT = HRESULT::from_constant(0xC03A0021); // ERROR_CTLOG_LOGFILE_SIZE_EXCEEDED_MAXSIZE

/// VHD file is changed due to compaction, expansion, or offline updates.
pub const CTLOG_VHD_CHANGED_OFFLINE : HRESULT = HRESULT::from_constant(0xC03A0022); // ERROR_CTLOG_VHD_CHANGED_OFFLINE

/// Change Tracking for the virtual disk is not in a valid state to perform this request.  Change tracking could be discontinued or already in the requested state.
pub const CTLOG_INVALID_TRACKING_STATE : HRESULT = HRESULT::from_constant(0xC03A0023); // ERROR_CTLOG_INVALID_TRACKING_STATE

/// Change Tracking file for the virtual disk is not in a valid state.
pub const CTLOG_INCONSISTENT_TRACKING_FILE : HRESULT = HRESULT::from_constant(0xC03A0024); // ERROR_CTLOG_INCONSISTENT_TRACKING_FILE

#[doc(hidden)] pub const VHD_RESIZE_WOULD_TRUNCATE_DATA : HRESULT = HRESULT::from_constant(0xC03A0025); // ERROR_VHD_RESIZE_WOULD_TRUNCATE_DATA
#[doc(hidden)] pub const VHD_COULD_NOT_COMPUTE_MINIMUM_VIRTUAL_SIZE : HRESULT = HRESULT::from_constant(0xC03A0026); // ERROR_VHD_COULD_NOT_COMPUTE_MINIMUM_VIRTUAL_SIZE
#[doc(hidden)] pub const VHD_ALREADY_AT_OR_BELOW_MINIMUM_VIRTUAL_SIZE : HRESULT = HRESULT::from_constant(0xC03A0027); // ERROR_VHD_ALREADY_AT_OR_BELOW_MINIMUM_VIRTUAL_SIZE
#[doc(hidden)] pub const VHD_METADATA_FULL : HRESULT = HRESULT::from_constant(0xC03A0028); // ERROR_VHD_METADATA_FULL
#[doc(hidden)] pub const VHD_INVALID_CHANGE_TRACKING_ID : HRESULT = HRESULT::from_constant(0xC03A0029); // ERROR_VHD_INVALID_CHANGE_TRACKING_ID
#[doc(hidden)] pub const VHD_CHANGE_TRACKING_DISABLED : HRESULT = HRESULT::from_constant(0xC03A002A); // ERROR_VHD_CHANGE_TRACKING_DISABLED
#[doc(hidden)] pub const VHD_MISSING_CHANGE_TRACKING_INFORMATION : HRESULT = HRESULT::from_constant(0xC03A0030); // ERROR_VHD_MISSING_CHANGE_TRACKING_INFORMATION

/// The virtualization storage subsystem has generated an error.
pub const QUERY_STORAGE_ERROR : HRESULT = HRESULT::from_constant(0x803A0001); // ERROR_QUERY_STORAGE_ERROR

/// The storage pool was deleted by the driver. The object cache should be updated.
pub const SPACES_POOL_WAS_DELETED : HRESULT = HRESULT::from_constant(0x00E70001); // ERROR_SPACES_POOL_WAS_DELETED

/// The specified fault domain type or combination of minimum / maximum fault domain type is not valid.
pub const SPACES_FAULT_DOMAIN_TYPE_INVALID : HRESULT = HRESULT::from_constant(0x80E70001); // ERROR_SPACES_FAULT_DOMAIN_TYPE_INVALID

/// A Storage Spaces internal error occurred.
pub const SPACES_INTERNAL_ERROR : HRESULT = HRESULT::from_constant(0x80E70002); // ERROR_SPACES_INTERNAL_ERROR

/// The specified resiliency type is not valid.
pub const SPACES_RESILIENCY_TYPE_INVALID : HRESULT = HRESULT::from_constant(0x80E70003); // ERROR_SPACES_RESILIENCY_TYPE_INVALID

/// The physical disk's sector size is not supported by the storage pool.
pub const SPACES_DRIVE_SECTOR_SIZE_INVALID : HRESULT = HRESULT::from_constant(0x80E70004); // ERROR_SPACES_DRIVE_SECTOR_SIZE_INVALID

/// The requested redundancy is outside of the supported range of values.
pub const SPACES_DRIVE_REDUNDANCY_INVALID : HRESULT = HRESULT::from_constant(0x80E70006); // ERROR_SPACES_DRIVE_REDUNDANCY_INVALID

/// The number of data copies requested is outside of the supported range of values.
pub const SPACES_NUMBER_OF_DATA_COPIES_INVALID : HRESULT = HRESULT::from_constant(0x80E70007); // ERROR_SPACES_NUMBER_OF_DATA_COPIES_INVALID

/// The value for ParityLayout is outside of the supported range of values.
pub const SPACES_PARITY_LAYOUT_INVALID : HRESULT = HRESULT::from_constant(0x80E70008); // ERROR_SPACES_PARITY_LAYOUT_INVALID

/// The value for interleave length is outside of the supported range of values or is not a power of 2.
pub const SPACES_INTERLEAVE_LENGTH_INVALID : HRESULT = HRESULT::from_constant(0x80E70009); // ERROR_SPACES_INTERLEAVE_LENGTH_INVALID

/// The number of columns specified is outside of the supported range of values.
pub const SPACES_NUMBER_OF_COLUMNS_INVALID : HRESULT = HRESULT::from_constant(0x80E7000A); // ERROR_SPACES_NUMBER_OF_COLUMNS_INVALID

/// There were not enough physical disks to complete the requested operation.
pub const SPACES_NOT_ENOUGH_DRIVES : HRESULT = HRESULT::from_constant(0x80E7000B); // ERROR_SPACES_NOT_ENOUGH_DRIVES

/// Extended error information is available.
pub const SPACES_EXTENDED_ERROR : HRESULT = HRESULT::from_constant(0x80E7000C); // ERROR_SPACES_EXTENDED_ERROR

/// The specified provisioning type is not valid.
pub const SPACES_PROVISIONING_TYPE_INVALID : HRESULT = HRESULT::from_constant(0x80E7000D); // ERROR_SPACES_PROVISIONING_TYPE_INVALID

/// The allocation size is outside of the supported range of values.
pub const SPACES_ALLOCATION_SIZE_INVALID : HRESULT = HRESULT::from_constant(0x80E7000E); // ERROR_SPACES_ALLOCATION_SIZE_INVALID

/// Enclosure awareness is not supported for this virtual disk.
pub const SPACES_ENCLOSURE_AWARE_INVALID : HRESULT = HRESULT::from_constant(0x80E7000F); // ERROR_SPACES_ENCLOSURE_AWARE_INVALID

/// The write cache size is outside of the supported range of values.
pub const SPACES_WRITE_CACHE_SIZE_INVALID : HRESULT = HRESULT::from_constant(0x80E70010); // ERROR_SPACES_WRITE_CACHE_SIZE_INVALID

/// The value for number of groups is outside of the supported range of values.
pub const SPACES_NUMBER_OF_GROUPS_INVALID : HRESULT = HRESULT::from_constant(0x80E70011); // ERROR_SPACES_NUMBER_OF_GROUPS_INVALID

/// The OperationalState of the physical disk is invalid for this operation.
pub const SPACES_DRIVE_OPERATIONAL_STATE_INVALID : HRESULT = HRESULT::from_constant(0x80E70012); // ERROR_SPACES_DRIVE_OPERATIONAL_STATE_INVALID

/// The specified log entry is not complete.
pub const SPACES_ENTRY_INCOMPLETE : HRESULT = HRESULT::from_constant(0x80E70013); // ERROR_SPACES_ENTRY_INCOMPLETE

/// The specified log entry is not valid.
pub const SPACES_ENTRY_INVALID : HRESULT = HRESULT::from_constant(0x80E70014); // ERROR_SPACES_ENTRY_INVALID

/// The bootfile is too small to support persistent snapshots.
pub const VOLSNAP_BOOTFILE_NOT_VALID : HRESULT = HRESULT::from_constant(0x80820001); // ERROR_VOLSNAP_BOOTFILE_NOT_VALID

/// Activation of persistent snapshots on this volume took longer than was allowed.
pub const VOLSNAP_ACTIVATION_TIMEOUT : HRESULT = HRESULT::from_constant(0x80820002); // ERROR_VOLSNAP_ACTIVATION_TIMEOUT

/// The specified volume does not support storage tiers.
pub const TIERING_NOT_SUPPORTED_ON_VOLUME : HRESULT = HRESULT::from_constant(0x80830001); // ERROR_TIERING_NOT_SUPPORTED_ON_VOLUME

/// The Storage Tiers Management service detected that the specified volume is in the process of being dismounted.
pub const TIERING_VOLUME_DISMOUNT_IN_PROGRESS : HRESULT = HRESULT::from_constant(0x80830002); // ERROR_TIERING_VOLUME_DISMOUNT_IN_PROGRESS

/// The specified storage tier could not be found on the volume. Confirm that the storage tier name is valid.
pub const TIERING_STORAGE_TIER_NOT_FOUND : HRESULT = HRESULT::from_constant(0x80830003); // ERROR_TIERING_STORAGE_TIER_NOT_FOUND

/// The file identifier specified is not valid on the volume.
pub const TIERING_INVALID_FILE_ID : HRESULT = HRESULT::from_constant(0x80830004); // ERROR_TIERING_INVALID_FILE_ID

/// Storage tier operations must be called on the clustering node that owns the metadata volume.
pub const TIERING_WRONG_CLUSTER_NODE : HRESULT = HRESULT::from_constant(0x80830005); // ERROR_TIERING_WRONG_CLUSTER_NODE

/// The Storage Tiers Management service is already optimizing the storage tiers on the specified volume.
pub const TIERING_ALREADY_PROCESSING : HRESULT = HRESULT::from_constant(0x80830006); // ERROR_TIERING_ALREADY_PROCESSING

/// The requested object type cannot be assigned to a storage tier.
pub const TIERING_CANNOT_PIN_OBJECT : HRESULT = HRESULT::from_constant(0x80830007); // ERROR_TIERING_CANNOT_PIN_OBJECT

/// The requested file is not pinned to a tier.
pub const TIERING_FILE_IS_NOT_PINNED : HRESULT = HRESULT::from_constant(0x80830008); // ERROR_TIERING_FILE_IS_NOT_PINNED

/// The volume is not a tiered volume.
pub const NOT_A_TIERED_VOLUME : HRESULT = HRESULT::from_constant(0x80830009); // ERROR_NOT_A_TIERED_VOLUME

/// The requested attribute is not present on the specified file or directory.
pub const ATTRIBUTE_NOT_PRESENT : HRESULT = HRESULT::from_constant(0x8083000A); // ERROR_ATTRIBUTE_NOT_PRESENT

/// The command was not recognized by the security core
pub const SECCORE_INVALID_COMMAND : HRESULT = HRESULT::from_constant(0xC0E80000); // ERROR_SECCORE_INVALID_COMMAND

/// No applicable app licenses found.
pub const NO_APPLICABLE_APP_LICENSES_FOUND : HRESULT = HRESULT::from_constant(0xC0EA0001); // ERROR_NO_APPLICABLE_APP_LICENSES_FOUND

/// CLiP license not found.
pub const CLIP_LICENSE_NOT_FOUND : HRESULT = HRESULT::from_constant(0xC0EA0002); // ERROR_CLIP_LICENSE_NOT_FOUND

/// CLiP device license not found.
pub const CLIP_DEVICE_LICENSE_MISSING : HRESULT = HRESULT::from_constant(0xC0EA0003); // ERROR_CLIP_DEVICE_LICENSE_MISSING

/// CLiP license has an invalid signature.
pub const CLIP_LICENSE_INVALID_SIGNATURE : HRESULT = HRESULT::from_constant(0xC0EA0004); // ERROR_CLIP_LICENSE_INVALID_SIGNATURE

/// CLiP keyholder license is invalid or missing.
pub const CLIP_KEYHOLDER_LICENSE_MISSING_OR_INVALID : HRESULT = HRESULT::from_constant(0xC0EA0005); // ERROR_CLIP_KEYHOLDER_LICENSE_MISSING_OR_INVALID

/// CLiP license has expired.
pub const CLIP_LICENSE_EXPIRED : HRESULT = HRESULT::from_constant(0xC0EA0006); // ERROR_CLIP_LICENSE_EXPIRED

/// CLiP license is signed by an unknown source.
pub const CLIP_LICENSE_SIGNED_BY_UNKNOWN_SOURCE : HRESULT = HRESULT::from_constant(0xC0EA0007); // ERROR_CLIP_LICENSE_SIGNED_BY_UNKNOWN_SOURCE

/// CLiP license is not signed.
pub const CLIP_LICENSE_NOT_SIGNED : HRESULT = HRESULT::from_constant(0xC0EA0008); // ERROR_CLIP_LICENSE_NOT_SIGNED

/// CLiP license hardware ID is out of tolerance.
pub const CLIP_LICENSE_HARDWARE_ID_OUT_OF_TOLERANCE : HRESULT = HRESULT::from_constant(0xC0EA0009); // ERROR_CLIP_LICENSE_HARDWARE_ID_OUT_OF_TOLERANCE

/// CLiP license device ID does not match the device ID in the bound device license.
pub const CLIP_LICENSE_DEVICE_ID_MISMATCH : HRESULT = HRESULT::from_constant(0xC0EA000A); // ERROR_CLIP_LICENSE_DEVICE_ID_MISMATCH

#[doc(hidden)] pub const DBG_CREATE_PROCESS_FAILURE_LOCKDOWN : HRESULT = HRESULT::from_constant(0x80B00001); // ERROR_DBG_CREATE_PROCESS_FAILURE_LOCKDOWN
#[doc(hidden)] pub const DBG_ATTACH_PROCESS_FAILURE_LOCKDOWN : HRESULT = HRESULT::from_constant(0x80B00002); // ERROR_DBG_ATTACH_PROCESS_FAILURE_LOCKDOWN
#[doc(hidden)] pub const DBG_CONNECT_SERVER_FAILURE_LOCKDOWN : HRESULT = HRESULT::from_constant(0x80B00003); // ERROR_DBG_CONNECT_SERVER_FAILURE_LOCKDOWN
#[doc(hidden)] pub const DBG_START_SERVER_FAILURE_LOCKDOWN : HRESULT = HRESULT::from_constant(0x80B00004); // ERROR_DBG_START_SERVER_FAILURE_LOCKDOWN

/// The operation was preempted by a higher priority operation. It must be resumed later.
pub const IO_PREEMPTED : HRESULT = HRESULT::from_constant(0x89010001); // ERROR_IO_PREEMPTED

#[doc(hidden)] pub const SVHDX_ERROR_STORED : HRESULT = HRESULT::from_constant(0xC05C0000); // ERROR_SVHDX_ERROR_STORED
#[doc(hidden)] pub const SVHDX_ERROR_NOT_AVAILABLE : HRESULT = HRESULT::from_constant(0xC05CFF00); // ERROR_SVHDX_ERROR_NOT_AVAILABLE
#[doc(hidden)] pub const SVHDX_UNIT_ATTENTION_AVAILABLE : HRESULT = HRESULT::from_constant(0xC05CFF01); // ERROR_SVHDX_UNIT_ATTENTION_AVAILABLE
#[doc(hidden)] pub const SVHDX_UNIT_ATTENTION_CAPACITY_DATA_CHANGED : HRESULT = HRESULT::from_constant(0xC05CFF02); // ERROR_SVHDX_UNIT_ATTENTION_CAPACITY_DATA_CHANGED
#[doc(hidden)] pub const SVHDX_UNIT_ATTENTION_RESERVATIONS_PREEMPTED : HRESULT = HRESULT::from_constant(0xC05CFF03); // ERROR_SVHDX_UNIT_ATTENTION_RESERVATIONS_PREEMPTED
#[doc(hidden)] pub const SVHDX_UNIT_ATTENTION_RESERVATIONS_RELEASED : HRESULT = HRESULT::from_constant(0xC05CFF04); // ERROR_SVHDX_UNIT_ATTENTION_RESERVATIONS_RELEASED
#[doc(hidden)] pub const SVHDX_UNIT_ATTENTION_REGISTRATIONS_PREEMPTED : HRESULT = HRESULT::from_constant(0xC05CFF05); // ERROR_SVHDX_UNIT_ATTENTION_REGISTRATIONS_PREEMPTED
#[doc(hidden)] pub const SVHDX_UNIT_ATTENTION_OPERATING_DEFINITION_CHANGED : HRESULT = HRESULT::from_constant(0xC05CFF06); // ERROR_SVHDX_UNIT_ATTENTION_OPERATING_DEFINITION_CHANGED
#[doc(hidden)] pub const SVHDX_RESERVATION_CONFLICT : HRESULT = HRESULT::from_constant(0xC05CFF07); // ERROR_SVHDX_RESERVATION_CONFLICT
#[doc(hidden)] pub const SVHDX_WRONG_FILE_TYPE : HRESULT = HRESULT::from_constant(0xC05CFF08); // ERROR_SVHDX_WRONG_FILE_TYPE
#[doc(hidden)] pub const SVHDX_VERSION_MISMATCH : HRESULT = HRESULT::from_constant(0xC05CFF09); // ERROR_SVHDX_VERSION_MISMATCH
#[doc(hidden)] pub const VHD_SHARED : HRESULT = HRESULT::from_constant(0xC05CFF0A); // ERROR_VHD_SHARED
#[doc(hidden)] pub const SVHDX_NO_INITIATOR : HRESULT = HRESULT::from_constant(0xC05CFF0B); // ERROR_SVHDX_NO_INITIATOR

/// The requested operation failed due to a missing backing storage file.
pub const VHDSET_BACKING_STORAGE_NOT_FOUND : HRESULT = HRESULT::from_constant(0xC05CFF0C); // ERROR_VHDSET_BACKING_STORAGE_NOT_FOUND

/// Failed to negotiate a preauthentication integrity hash function.
pub const SMB_NO_PREAUTH_INTEGRITY_HASH_OVERLAP : HRESULT = HRESULT::from_constant(0xC05D0000); // ERROR_SMB_NO_PREAUTH_INTEGRITY_HASH_OVERLAP

/// The current cluster functional level does not support this SMB dialect.
pub const SMB_BAD_CLUSTER_DIALECT : HRESULT = HRESULT::from_constant(0xC05D0001); // ERROR_SMB_BAD_CLUSTER_DIALECT

/// The QUIC connection handshake failed.
pub const QUIC_HANDSHAKE_FAILURE : HRESULT = HRESULT::from_constant(0x80410000); // ERROR_QUIC_HANDSHAKE_FAILURE

/// The QUIC connection failed to negotiate a compatible protocol version.
pub const QUIC_VER_NEG_FAILURE : HRESULT = HRESULT::from_constant(0x80410001); // ERROR_QUIC_VER_NEG_FAILURE
