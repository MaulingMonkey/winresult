...
#[doc(hidden)] pub const PCW_PCP_DOESNT_EXIST : ErrorHResult = ErrorHResult::from_constant(3222163713); // ERROR_PCW_PCP_DOESNT_EXIST
#[doc(hidden)] pub const PCW_PCP_BAD_FORMAT : ErrorHResult = ErrorHResult::from_constant(3222163714); // ERROR_PCW_PCP_BAD_FORMAT
#[doc(hidden)] pub const PCW_CANT_CREATE_TEMP_FOLDER : ErrorHResult = ErrorHResult::from_constant(3222163715); // ERROR_PCW_CANT_CREATE_TEMP_FOLDER
#[doc(hidden)] pub const PCW_MISSING_PATCH_PATH : ErrorHResult = ErrorHResult::from_constant(3222163716); // ERROR_PCW_MISSING_PATCH_PATH
#[doc(hidden)] pub const PCW_CANT_OVERWRITE_PATCH : ErrorHResult = ErrorHResult::from_constant(3222163717); // ERROR_PCW_CANT_OVERWRITE_PATCH
#[doc(hidden)] pub const PCW_CANT_CREATE_PATCH_FILE : ErrorHResult = ErrorHResult::from_constant(3222163718); // ERROR_PCW_CANT_CREATE_PATCH_FILE
#[doc(hidden)] pub const PCW_MISSING_PATCH_GUID : ErrorHResult = ErrorHResult::from_constant(3222163719); // ERROR_PCW_MISSING_PATCH_GUID
#[doc(hidden)] pub const PCW_BAD_PATCH_GUID : ErrorHResult = ErrorHResult::from_constant(3222163720); // ERROR_PCW_BAD_PATCH_GUID
#[doc(hidden)] pub const PCW_BAD_GUIDS_TO_REPLACE : ErrorHResult = ErrorHResult::from_constant(3222163721); // ERROR_PCW_BAD_GUIDS_TO_REPLACE
#[doc(hidden)] pub const PCW_BAD_TARGET_PRODUCT_CODE_LIST : ErrorHResult = ErrorHResult::from_constant(3222163722); // ERROR_PCW_BAD_TARGET_PRODUCT_CODE_LIST
#[doc(hidden)] pub const PCW_NO_UPGRADED_IMAGES_TO_PATCH : ErrorHResult = ErrorHResult::from_constant(3222163723); // ERROR_PCW_NO_UPGRADED_IMAGES_TO_PATCH
#[doc(hidden)] pub const PCW_BAD_API_PATCHING_SYMBOL_FLAGS : ErrorHResult = ErrorHResult::from_constant(3222163725); // ERROR_PCW_BAD_API_PATCHING_SYMBOL_FLAGS
#[doc(hidden)] pub const PCW_OODS_COPYING_MSI : ErrorHResult = ErrorHResult::from_constant(3222163726); // ERROR_PCW_OODS_COPYING_MSI
#[doc(hidden)] pub const PCW_UPGRADED_IMAGE_NAME_TOO_LONG : ErrorHResult = ErrorHResult::from_constant(3222163727); // ERROR_PCW_UPGRADED_IMAGE_NAME_TOO_LONG
#[doc(hidden)] pub const PCW_BAD_UPGRADED_IMAGE_NAME : ErrorHResult = ErrorHResult::from_constant(3222163728); // ERROR_PCW_BAD_UPGRADED_IMAGE_NAME
#[doc(hidden)] pub const PCW_DUP_UPGRADED_IMAGE_NAME : ErrorHResult = ErrorHResult::from_constant(3222163729); // ERROR_PCW_DUP_UPGRADED_IMAGE_NAME
#[doc(hidden)] pub const PCW_UPGRADED_IMAGE_PATH_TOO_LONG : ErrorHResult = ErrorHResult::from_constant(3222163730); // ERROR_PCW_UPGRADED_IMAGE_PATH_TOO_LONG
#[doc(hidden)] pub const PCW_UPGRADED_IMAGE_PATH_EMPTY : ErrorHResult = ErrorHResult::from_constant(3222163731); // ERROR_PCW_UPGRADED_IMAGE_PATH_EMPTY
#[doc(hidden)] pub const PCW_UPGRADED_IMAGE_PATH_NOT_EXIST : ErrorHResult = ErrorHResult::from_constant(3222163732); // ERROR_PCW_UPGRADED_IMAGE_PATH_NOT_EXIST
#[doc(hidden)] pub const PCW_UPGRADED_IMAGE_PATH_NOT_MSI : ErrorHResult = ErrorHResult::from_constant(3222163733); // ERROR_PCW_UPGRADED_IMAGE_PATH_NOT_MSI
#[doc(hidden)] pub const PCW_UPGRADED_IMAGE_COMPRESSED : ErrorHResult = ErrorHResult::from_constant(3222163734); // ERROR_PCW_UPGRADED_IMAGE_COMPRESSED
#[doc(hidden)] pub const PCW_TARGET_IMAGE_NAME_TOO_LONG : ErrorHResult = ErrorHResult::from_constant(3222163735); // ERROR_PCW_TARGET_IMAGE_NAME_TOO_LONG
#[doc(hidden)] pub const PCW_BAD_TARGET_IMAGE_NAME : ErrorHResult = ErrorHResult::from_constant(3222163736); // ERROR_PCW_BAD_TARGET_IMAGE_NAME
#[doc(hidden)] pub const PCW_DUP_TARGET_IMAGE_NAME : ErrorHResult = ErrorHResult::from_constant(3222163737); // ERROR_PCW_DUP_TARGET_IMAGE_NAME
#[doc(hidden)] pub const PCW_TARGET_IMAGE_PATH_TOO_LONG : ErrorHResult = ErrorHResult::from_constant(3222163738); // ERROR_PCW_TARGET_IMAGE_PATH_TOO_LONG
#[doc(hidden)] pub const PCW_TARGET_IMAGE_PATH_EMPTY : ErrorHResult = ErrorHResult::from_constant(3222163739); // ERROR_PCW_TARGET_IMAGE_PATH_EMPTY
#[doc(hidden)] pub const PCW_TARGET_IMAGE_PATH_NOT_EXIST : ErrorHResult = ErrorHResult::from_constant(3222163740); // ERROR_PCW_TARGET_IMAGE_PATH_NOT_EXIST
#[doc(hidden)] pub const PCW_TARGET_IMAGE_PATH_NOT_MSI : ErrorHResult = ErrorHResult::from_constant(3222163741); // ERROR_PCW_TARGET_IMAGE_PATH_NOT_MSI
#[doc(hidden)] pub const PCW_TARGET_IMAGE_COMPRESSED : ErrorHResult = ErrorHResult::from_constant(3222163742); // ERROR_PCW_TARGET_IMAGE_COMPRESSED
#[doc(hidden)] pub const PCW_TARGET_BAD_PROD_VALIDATE : ErrorHResult = ErrorHResult::from_constant(3222163743); // ERROR_PCW_TARGET_BAD_PROD_VALIDATE
#[doc(hidden)] pub const PCW_TARGET_BAD_PROD_CODE_VAL : ErrorHResult = ErrorHResult::from_constant(3222163744); // ERROR_PCW_TARGET_BAD_PROD_CODE_VAL
#[doc(hidden)] pub const PCW_UPGRADED_MISSING_SRC_FILES : ErrorHResult = ErrorHResult::from_constant(3222163745); // ERROR_PCW_UPGRADED_MISSING_SRC_FILES
#[doc(hidden)] pub const PCW_TARGET_MISSING_SRC_FILES : ErrorHResult = ErrorHResult::from_constant(3222163746); // ERROR_PCW_TARGET_MISSING_SRC_FILES
#[doc(hidden)] pub const PCW_IMAGE_FAMILY_NAME_TOO_LONG : ErrorHResult = ErrorHResult::from_constant(3222163747); // ERROR_PCW_IMAGE_FAMILY_NAME_TOO_LONG
#[doc(hidden)] pub const PCW_BAD_IMAGE_FAMILY_NAME : ErrorHResult = ErrorHResult::from_constant(3222163748); // ERROR_PCW_BAD_IMAGE_FAMILY_NAME
#[doc(hidden)] pub const PCW_DUP_IMAGE_FAMILY_NAME : ErrorHResult = ErrorHResult::from_constant(3222163749); // ERROR_PCW_DUP_IMAGE_FAMILY_NAME
#[doc(hidden)] pub const PCW_BAD_IMAGE_FAMILY_SRC_PROP : ErrorHResult = ErrorHResult::from_constant(3222163750); // ERROR_PCW_BAD_IMAGE_FAMILY_SRC_PROP
#[doc(hidden)] pub const PCW_UFILEDATA_LONG_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163751); // ERROR_PCW_UFILEDATA_LONG_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_UFILEDATA_BLANK_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163752); // ERROR_PCW_UFILEDATA_BLANK_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_UFILEDATA_MISSING_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163753); // ERROR_PCW_UFILEDATA_MISSING_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_EXTFILE_LONG_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163754); // ERROR_PCW_EXTFILE_LONG_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_EXTFILE_BLANK_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163755); // ERROR_PCW_EXTFILE_BLANK_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_EXTFILE_BAD_FAMILY_FIELD : ErrorHResult = ErrorHResult::from_constant(3222163756); // ERROR_PCW_EXTFILE_BAD_FAMILY_FIELD
#[doc(hidden)] pub const PCW_EXTFILE_LONG_PATH_TO_FILE : ErrorHResult = ErrorHResult::from_constant(3222163757); // ERROR_PCW_EXTFILE_LONG_PATH_TO_FILE
#[doc(hidden)] pub const PCW_EXTFILE_BLANK_PATH_TO_FILE : ErrorHResult = ErrorHResult::from_constant(3222163758); // ERROR_PCW_EXTFILE_BLANK_PATH_TO_FILE
#[doc(hidden)] pub const PCW_EXTFILE_MISSING_FILE : ErrorHResult = ErrorHResult::from_constant(3222163759); // ERROR_PCW_EXTFILE_MISSING_FILE
#[doc(hidden)] pub const PCW_BAD_FILE_SEQUENCE_START : ErrorHResult = ErrorHResult::from_constant(3222163770); // ERROR_PCW_BAD_FILE_SEQUENCE_START
#[doc(hidden)] pub const PCW_CANT_COPY_FILE_TO_TEMP_FOLDER : ErrorHResult = ErrorHResult::from_constant(3222163771); // ERROR_PCW_CANT_COPY_FILE_TO_TEMP_FOLDER
#[doc(hidden)] pub const PCW_CANT_CREATE_ONE_PATCH_FILE : ErrorHResult = ErrorHResult::from_constant(3222163772); // ERROR_PCW_CANT_CREATE_ONE_PATCH_FILE
#[doc(hidden)] pub const PCW_BAD_IMAGE_FAMILY_DISKID : ErrorHResult = ErrorHResult::from_constant(3222163773); // ERROR_PCW_BAD_IMAGE_FAMILY_DISKID
#[doc(hidden)] pub const PCW_BAD_IMAGE_FAMILY_FILESEQSTART : ErrorHResult = ErrorHResult::from_constant(3222163774); // ERROR_PCW_BAD_IMAGE_FAMILY_FILESEQSTART
#[doc(hidden)] pub const PCW_BAD_UPGRADED_IMAGE_FAMILY : ErrorHResult = ErrorHResult::from_constant(3222163775); // ERROR_PCW_BAD_UPGRADED_IMAGE_FAMILY
#[doc(hidden)] pub const PCW_BAD_TARGET_IMAGE_UPGRADED : ErrorHResult = ErrorHResult::from_constant(3222163776); // ERROR_PCW_BAD_TARGET_IMAGE_UPGRADED
#[doc(hidden)] pub const PCW_DUP_TARGET_IMAGE_PACKCODE : ErrorHResult = ErrorHResult::from_constant(3222163777); // ERROR_PCW_DUP_TARGET_IMAGE_PACKCODE
#[doc(hidden)] pub const PCW_UFILEDATA_BAD_UPGRADED_FIELD : ErrorHResult = ErrorHResult::from_constant(3222163778); // ERROR_PCW_UFILEDATA_BAD_UPGRADED_FIELD
#[doc(hidden)] pub const PCW_MISMATCHED_PRODUCT_CODES : ErrorHResult = ErrorHResult::from_constant(3222163779); // ERROR_PCW_MISMATCHED_PRODUCT_CODES
#[doc(hidden)] pub const PCW_MISMATCHED_PRODUCT_VERSIONS : ErrorHResult = ErrorHResult::from_constant(3222163780); // ERROR_PCW_MISMATCHED_PRODUCT_VERSIONS
#[doc(hidden)] pub const PCW_CANNOT_WRITE_DDF : ErrorHResult = ErrorHResult::from_constant(3222163781); // ERROR_PCW_CANNOT_WRITE_DDF
#[doc(hidden)] pub const PCW_CANNOT_RUN_MAKECAB : ErrorHResult = ErrorHResult::from_constant(3222163782); // ERROR_PCW_CANNOT_RUN_MAKECAB
#[doc(hidden)] pub const PCW_WRITE_SUMMARY_PROPERTIES : ErrorHResult = ErrorHResult::from_constant(3222163787); // ERROR_PCW_WRITE_SUMMARY_PROPERTIES
#[doc(hidden)] pub const PCW_TFILEDATA_LONG_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163788); // ERROR_PCW_TFILEDATA_LONG_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_TFILEDATA_BLANK_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163789); // ERROR_PCW_TFILEDATA_BLANK_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_TFILEDATA_MISSING_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163790); // ERROR_PCW_TFILEDATA_MISSING_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_TFILEDATA_BAD_TARGET_FIELD : ErrorHResult = ErrorHResult::from_constant(3222163791); // ERROR_PCW_TFILEDATA_BAD_TARGET_FIELD
#[doc(hidden)] pub const PCW_UPGRADED_IMAGE_PATCH_PATH_TOO_LONG : ErrorHResult = ErrorHResult::from_constant(3222163792); // ERROR_PCW_UPGRADED_IMAGE_PATCH_PATH_TOO_LONG
#[doc(hidden)] pub const PCW_UPGRADED_IMAGE_PATCH_PATH_NOT_EXIST : ErrorHResult = ErrorHResult::from_constant(3222163793); // ERROR_PCW_UPGRADED_IMAGE_PATCH_PATH_NOT_EXIST
#[doc(hidden)] pub const PCW_UPGRADED_IMAGE_PATCH_PATH_NOT_MSI : ErrorHResult = ErrorHResult::from_constant(3222163794); // ERROR_PCW_UPGRADED_IMAGE_PATCH_PATH_NOT_MSI
#[doc(hidden)] pub const PCW_DUP_UPGRADED_IMAGE_PACKCODE : ErrorHResult = ErrorHResult::from_constant(3222163795); // ERROR_PCW_DUP_UPGRADED_IMAGE_PACKCODE
#[doc(hidden)] pub const PCW_UFILEIGNORE_BAD_UPGRADED_FIELD : ErrorHResult = ErrorHResult::from_constant(3222163796); // ERROR_PCW_UFILEIGNORE_BAD_UPGRADED_FIELD
#[doc(hidden)] pub const PCW_UFILEIGNORE_LONG_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163797); // ERROR_PCW_UFILEIGNORE_LONG_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_UFILEIGNORE_BLANK_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163798); // ERROR_PCW_UFILEIGNORE_BLANK_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_UFILEIGNORE_BAD_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163799); // ERROR_PCW_UFILEIGNORE_BAD_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_FAMILY_RANGE_NAME_TOO_LONG : ErrorHResult = ErrorHResult::from_constant(3222163800); // ERROR_PCW_FAMILY_RANGE_NAME_TOO_LONG
#[doc(hidden)] pub const PCW_BAD_FAMILY_RANGE_NAME : ErrorHResult = ErrorHResult::from_constant(3222163801); // ERROR_PCW_BAD_FAMILY_RANGE_NAME
#[doc(hidden)] pub const PCW_FAMILY_RANGE_LONG_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163802); // ERROR_PCW_FAMILY_RANGE_LONG_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_FAMILY_RANGE_BLANK_FILE_TABLE_KEY : ErrorHResult = ErrorHResult::from_constant(3222163803); // ERROR_PCW_FAMILY_RANGE_BLANK_FILE_TABLE_KEY
#[doc(hidden)] pub const PCW_FAMILY_RANGE_LONG_RETAIN_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163804); // ERROR_PCW_FAMILY_RANGE_LONG_RETAIN_OFFSETS
#[doc(hidden)] pub const PCW_FAMILY_RANGE_BLANK_RETAIN_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163805); // ERROR_PCW_FAMILY_RANGE_BLANK_RETAIN_OFFSETS
#[doc(hidden)] pub const PCW_FAMILY_RANGE_BAD_RETAIN_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163806); // ERROR_PCW_FAMILY_RANGE_BAD_RETAIN_OFFSETS
#[doc(hidden)] pub const PCW_FAMILY_RANGE_LONG_RETAIN_LENGTHS : ErrorHResult = ErrorHResult::from_constant(3222163807); // ERROR_PCW_FAMILY_RANGE_LONG_RETAIN_LENGTHS
#[doc(hidden)] pub const PCW_FAMILY_RANGE_BLANK_RETAIN_LENGTHS : ErrorHResult = ErrorHResult::from_constant(3222163808); // ERROR_PCW_FAMILY_RANGE_BLANK_RETAIN_LENGTHS
#[doc(hidden)] pub const PCW_FAMILY_RANGE_BAD_RETAIN_LENGTHS : ErrorHResult = ErrorHResult::from_constant(3222163809); // ERROR_PCW_FAMILY_RANGE_BAD_RETAIN_LENGTHS
#[doc(hidden)] pub const PCW_FAMILY_RANGE_COUNT_MISMATCH : ErrorHResult = ErrorHResult::from_constant(3222163810); // ERROR_PCW_FAMILY_RANGE_COUNT_MISMATCH
#[doc(hidden)] pub const PCW_EXTFILE_LONG_IGNORE_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163811); // ERROR_PCW_EXTFILE_LONG_IGNORE_OFFSETS
#[doc(hidden)] pub const PCW_EXTFILE_BAD_IGNORE_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163812); // ERROR_PCW_EXTFILE_BAD_IGNORE_OFFSETS
#[doc(hidden)] pub const PCW_EXTFILE_LONG_IGNORE_LENGTHS : ErrorHResult = ErrorHResult::from_constant(3222163813); // ERROR_PCW_EXTFILE_LONG_IGNORE_LENGTHS
#[doc(hidden)] pub const PCW_EXTFILE_BAD_IGNORE_LENGTHS : ErrorHResult = ErrorHResult::from_constant(3222163814); // ERROR_PCW_EXTFILE_BAD_IGNORE_LENGTHS
#[doc(hidden)] pub const PCW_EXTFILE_IGNORE_COUNT_MISMATCH : ErrorHResult = ErrorHResult::from_constant(3222163815); // ERROR_PCW_EXTFILE_IGNORE_COUNT_MISMATCH
#[doc(hidden)] pub const PCW_EXTFILE_LONG_RETAIN_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163816); // ERROR_PCW_EXTFILE_LONG_RETAIN_OFFSETS
#[doc(hidden)] pub const PCW_EXTFILE_BAD_RETAIN_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163817); // ERROR_PCW_EXTFILE_BAD_RETAIN_OFFSETS
#[doc(hidden)] pub const PCW_TFILEDATA_LONG_IGNORE_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163819); // ERROR_PCW_TFILEDATA_LONG_IGNORE_OFFSETS
#[doc(hidden)] pub const PCW_TFILEDATA_BAD_IGNORE_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163820); // ERROR_PCW_TFILEDATA_BAD_IGNORE_OFFSETS
#[doc(hidden)] pub const PCW_TFILEDATA_LONG_IGNORE_LENGTHS : ErrorHResult = ErrorHResult::from_constant(3222163821); // ERROR_PCW_TFILEDATA_LONG_IGNORE_LENGTHS
#[doc(hidden)] pub const PCW_TFILEDATA_BAD_IGNORE_LENGTHS : ErrorHResult = ErrorHResult::from_constant(3222163822); // ERROR_PCW_TFILEDATA_BAD_IGNORE_LENGTHS
#[doc(hidden)] pub const PCW_TFILEDATA_IGNORE_COUNT_MISMATCH : ErrorHResult = ErrorHResult::from_constant(3222163823); // ERROR_PCW_TFILEDATA_IGNORE_COUNT_MISMATCH
#[doc(hidden)] pub const PCW_TFILEDATA_LONG_RETAIN_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163824); // ERROR_PCW_TFILEDATA_LONG_RETAIN_OFFSETS
#[doc(hidden)] pub const PCW_TFILEDATA_BAD_RETAIN_OFFSETS : ErrorHResult = ErrorHResult::from_constant(3222163825); // ERROR_PCW_TFILEDATA_BAD_RETAIN_OFFSETS
#[doc(hidden)] pub const PCW_CANT_GENERATE_TRANSFORM : ErrorHResult = ErrorHResult::from_constant(3222163827); // ERROR_PCW_CANT_GENERATE_TRANSFORM
#[doc(hidden)] pub const PCW_CANT_CREATE_SUMMARY_INFO : ErrorHResult = ErrorHResult::from_constant(3222163828); // ERROR_PCW_CANT_CREATE_SUMMARY_INFO
#[doc(hidden)] pub const PCW_CANT_GENERATE_TRANSFORM_POUND : ErrorHResult = ErrorHResult::from_constant(3222163829); // ERROR_PCW_CANT_GENERATE_TRANSFORM_POUND
#[doc(hidden)] pub const PCW_CANT_CREATE_SUMMARY_INFO_POUND : ErrorHResult = ErrorHResult::from_constant(3222163830); // ERROR_PCW_CANT_CREATE_SUMMARY_INFO_POUND
#[doc(hidden)] pub const PCW_BAD_UPGRADED_IMAGE_PRODUCT_CODE : ErrorHResult = ErrorHResult::from_constant(3222163831); // ERROR_PCW_BAD_UPGRADED_IMAGE_PRODUCT_CODE
#[doc(hidden)] pub const PCW_BAD_UPGRADED_IMAGE_PRODUCT_VERSION : ErrorHResult = ErrorHResult::from_constant(3222163832); // ERROR_PCW_BAD_UPGRADED_IMAGE_PRODUCT_VERSION
#[doc(hidden)] pub const PCW_BAD_UPGRADED_IMAGE_UPGRADE_CODE : ErrorHResult = ErrorHResult::from_constant(3222163833); // ERROR_PCW_BAD_UPGRADED_IMAGE_UPGRADE_CODE
#[doc(hidden)] pub const PCW_BAD_TARGET_IMAGE_PRODUCT_CODE : ErrorHResult = ErrorHResult::from_constant(3222163834); // ERROR_PCW_BAD_TARGET_IMAGE_PRODUCT_CODE
#[doc(hidden)] pub const PCW_BAD_TARGET_IMAGE_PRODUCT_VERSION : ErrorHResult = ErrorHResult::from_constant(3222163835); // ERROR_PCW_BAD_TARGET_IMAGE_PRODUCT_VERSION
#[doc(hidden)] pub const PCW_BAD_TARGET_IMAGE_UPGRADE_CODE : ErrorHResult = ErrorHResult::from_constant(3222163836); // ERROR_PCW_BAD_TARGET_IMAGE_UPGRADE_CODE
#[doc(hidden)] pub const PCW_MATCHED_PRODUCT_VERSIONS : ErrorHResult = ErrorHResult::from_constant(3222163837); // ERROR_PCW_MATCHED_PRODUCT_VERSIONS
#[doc(hidden)] pub const PCW_OBSOLETION_WITH_SEQUENCE_DATA : ErrorHResult = ErrorHResult::from_constant(3222163838); // ERROR_PCW_OBSOLETION_WITH_SEQUENCE_DATA
#[doc(hidden)] pub const PCW_OBSOLETION_WITH_MSI30 : ErrorHResult = ErrorHResult::from_constant(3222163839); // ERROR_PCW_OBSOLETION_WITH_MSI30
#[doc(hidden)] pub const PCW_OBSOLETION_WITH_PATCHSEQUENCE : ErrorHResult = ErrorHResult::from_constant(3222163840); // ERROR_PCW_OBSOLETION_WITH_PATCHSEQUENCE
#[doc(hidden)] pub const PCW_CANNOT_CREATE_TABLE : ErrorHResult = ErrorHResult::from_constant(3222163841); // ERROR_PCW_CANNOT_CREATE_TABLE
#[doc(hidden)] pub const PCW_CANT_GENERATE_SEQUENCEINFO_MAJORUPGD : ErrorHResult = ErrorHResult::from_constant(3222163842); // ERROR_PCW_CANT_GENERATE_SEQUENCEINFO_MAJORUPGD
#[doc(hidden)] pub const PCW_MAJOR_UPGD_WITHOUT_SEQUENCING : ErrorHResult = ErrorHResult::from_constant(3222163843); // ERROR_PCW_MAJOR_UPGD_WITHOUT_SEQUENCING
#[doc(hidden)] pub const PCW_BAD_PRODUCTVERSION_VALIDATION : ErrorHResult = ErrorHResult::from_constant(3222163844); // ERROR_PCW_BAD_PRODUCTVERSION_VALIDATION
#[doc(hidden)] pub const PCW_BAD_TRANSFORMSET : ErrorHResult = ErrorHResult::from_constant(3222163845); // ERROR_PCW_BAD_TRANSFORMSET
#[doc(hidden)] pub const PCW_BAD_TGT_UPD_IMAGES : ErrorHResult = ErrorHResult::from_constant(3222163846); // ERROR_PCW_BAD_TGT_UPD_IMAGES
#[doc(hidden)] pub const PCW_BAD_SUPERCEDENCE : ErrorHResult = ErrorHResult::from_constant(3222163847); // ERROR_PCW_BAD_SUPERCEDENCE
#[doc(hidden)] pub const PCW_BAD_SEQUENCE : ErrorHResult = ErrorHResult::from_constant(3222163848); // ERROR_PCW_BAD_SEQUENCE
#[doc(hidden)] pub const PCW_BAD_TARGET : ErrorHResult = ErrorHResult::from_constant(3222163849); // ERROR_PCW_BAD_TARGET
#[doc(hidden)] pub const PCW_NULL_PATCHFAMILY : ErrorHResult = ErrorHResult::from_constant(3222163850); // ERROR_PCW_NULL_PATCHFAMILY
#[doc(hidden)] pub const PCW_NULL_SEQUENCE_NUMBER : ErrorHResult = ErrorHResult::from_constant(3222163851); // ERROR_PCW_NULL_SEQUENCE_NUMBER
#[doc(hidden)] pub const PCW_BAD_VERSION_STRING : ErrorHResult = ErrorHResult::from_constant(3222163852); // ERROR_PCW_BAD_VERSION_STRING
#[doc(hidden)] pub const PCW_BAD_MAJOR_VERSION : ErrorHResult = ErrorHResult::from_constant(3222163853); // ERROR_PCW_BAD_MAJOR_VERSION
#[doc(hidden)] pub const PCW_SEQUENCING_BAD_TARGET : ErrorHResult = ErrorHResult::from_constant(3222163854); // ERROR_PCW_SEQUENCING_BAD_TARGET
#[doc(hidden)] pub const PCW_PATCHMETADATA_PROP_NOT_SET : ErrorHResult = ErrorHResult::from_constant(3222163855); // ERROR_PCW_PATCHMETADATA_PROP_NOT_SET
#[doc(hidden)] pub const PCW_INVALID_PATCHMETADATA_PROP : ErrorHResult = ErrorHResult::from_constant(3222163856); // ERROR_PCW_INVALID_PATCHMETADATA_PROP
#[doc(hidden)] pub const PCW_INVALID_SUPERCEDENCE : ErrorHResult = ErrorHResult::from_constant(3222163857); // ERROR_PCW_INVALID_SUPERCEDENCE
#[doc(hidden)] pub const PCW_DUPLICATE_SEQUENCE_RECORD : ErrorHResult = ErrorHResult::from_constant(3222163858); // ERROR_PCW_DUPLICATE_SEQUENCE_RECORD
#[doc(hidden)] pub const PCW_WRONG_PATCHMETADATA_STRD_PROP : ErrorHResult = ErrorHResult::from_constant(3222163859); // ERROR_PCW_WRONG_PATCHMETADATA_STRD_PROP
#[doc(hidden)] pub const PCW_INVALID_PARAMETER : ErrorHResult = ErrorHResult::from_constant(3222163860); // ERROR_PCW_INVALID_PARAMETER
#[doc(hidden)] pub const PCW_CREATEFILE_LOG_FAILED : ErrorHResult = ErrorHResult::from_constant(3222163861); // ERROR_PCW_CREATEFILE_LOG_FAILED
#[doc(hidden)] pub const PCW_INVALID_LOG_LEVEL : ErrorHResult = ErrorHResult::from_constant(3222163862); // ERROR_PCW_INVALID_LOG_LEVEL
#[doc(hidden)] pub const PCW_INVALID_UI_LEVEL : ErrorHResult = ErrorHResult::from_constant(3222163863); // ERROR_PCW_INVALID_UI_LEVEL
#[doc(hidden)] pub const PCW_ERROR_WRITING_TO_LOG : ErrorHResult = ErrorHResult::from_constant(3222163864); // ERROR_PCW_ERROR_WRITING_TO_LOG
#[doc(hidden)] pub const PCW_OUT_OF_MEMORY : ErrorHResult = ErrorHResult::from_constant(3222163865); // ERROR_PCW_OUT_OF_MEMORY
#[doc(hidden)] pub const PCW_UNKNOWN_ERROR : ErrorHResult = ErrorHResult::from_constant(3222163866); // ERROR_PCW_UNKNOWN_ERROR
#[doc(hidden)] pub const PCW_UNKNOWN_INFO : ErrorHResult = ErrorHResult::from_constant(3222163867); // ERROR_PCW_UNKNOWN_INFO
#[doc(hidden)] pub const PCW_UNKNOWN_WARN : ErrorHResult = ErrorHResult::from_constant(3222163868); // ERROR_PCW_UNKNOWN_WARN
#[doc(hidden)] pub const PCW_OPEN_VIEW : ErrorHResult = ErrorHResult::from_constant(3222163869); // ERROR_PCW_OPEN_VIEW
#[doc(hidden)] pub const PCW_EXECUTE_VIEW : ErrorHResult = ErrorHResult::from_constant(3222163870); // ERROR_PCW_EXECUTE_VIEW
#[doc(hidden)] pub const PCW_VIEW_FETCH : ErrorHResult = ErrorHResult::from_constant(3222163871); // ERROR_PCW_VIEW_FETCH
#[doc(hidden)] pub const PCW_FAILED_EXPAND_PATH : ErrorHResult = ErrorHResult::from_constant(3222163872); // ERROR_PCW_FAILED_EXPAND_PATH
#[doc(hidden)] pub const PCW_INTERNAL_ERROR : ErrorHResult = ErrorHResult::from_constant(3222163969); // ERROR_PCW_INTERNAL_ERROR
#[doc(hidden)] pub const PCW_INVALID_PCP_PROPERTY : ErrorHResult = ErrorHResult::from_constant(3222163970); // ERROR_PCW_INVALID_PCP_PROPERTY
#[doc(hidden)] pub const PCW_INVALID_PCP_TARGETIMAGES : ErrorHResult = ErrorHResult::from_constant(3222163971); // ERROR_PCW_INVALID_PCP_TARGETIMAGES
#[doc(hidden)] pub const PCW_LAX_VALIDATION_FLAGS : ErrorHResult = ErrorHResult::from_constant(3222163972); // ERROR_PCW_LAX_VALIDATION_FLAGS
#[doc(hidden)] pub const PCW_FAILED_CREATE_TRANSFORM : ErrorHResult = ErrorHResult::from_constant(3222163973); // ERROR_PCW_FAILED_CREATE_TRANSFORM
#[doc(hidden)] pub const PCW_CANT_DELETE_TEMP_FOLDER : ErrorHResult = ErrorHResult::from_constant(3222163974); // ERROR_PCW_CANT_DELETE_TEMP_FOLDER
#[doc(hidden)] pub const PCW_MISSING_DIRECTORY_TABLE : ErrorHResult = ErrorHResult::from_constant(3222163975); // ERROR_PCW_MISSING_DIRECTORY_TABLE
#[doc(hidden)] pub const PCW_INVALID_SUPERSEDENCE_VALUE : ErrorHResult = ErrorHResult::from_constant(3222163976); // ERROR_PCW_INVALID_SUPERSEDENCE_VALUE
#[doc(hidden)] pub const PCW_INVALID_PATCH_TYPE_SEQUENCING : ErrorHResult = ErrorHResult::from_constant(3222163977); // ERROR_PCW_INVALID_PATCH_TYPE_SEQUENCING
#[doc(hidden)] pub const PCW_CANT_READ_FILE : ErrorHResult = ErrorHResult::from_constant(3222163978); // ERROR_PCW_CANT_READ_FILE
#[doc(hidden)] pub const PCW_TARGET_WRONG_PRODUCT_VERSION_COMP : ErrorHResult = ErrorHResult::from_constant(3222163979); // ERROR_PCW_TARGET_WRONG_PRODUCT_VERSION_COMP
#[doc(hidden)] pub const PCW_INVALID_PCP_UPGRADEDFILESTOIGNORE : ErrorHResult = ErrorHResult::from_constant(3222163980); // ERROR_PCW_INVALID_PCP_UPGRADEDFILESTOIGNORE
#[doc(hidden)] pub const PCW_INVALID_PCP_UPGRADEDIMAGES : ErrorHResult = ErrorHResult::from_constant(3222163981); // ERROR_PCW_INVALID_PCP_UPGRADEDIMAGES
#[doc(hidden)] pub const PCW_INVALID_PCP_EXTERNALFILES : ErrorHResult = ErrorHResult::from_constant(3222163982); // ERROR_PCW_INVALID_PCP_EXTERNALFILES
#[doc(hidden)] pub const PCW_INVALID_PCP_IMAGEFAMILIES : ErrorHResult = ErrorHResult::from_constant(3222163983); // ERROR_PCW_INVALID_PCP_IMAGEFAMILIES
#[doc(hidden)] pub const PCW_INVALID_PCP_PATCHSEQUENCE : ErrorHResult = ErrorHResult::from_constant(3222163984); // ERROR_PCW_INVALID_PCP_PATCHSEQUENCE
#[doc(hidden)] pub const PCW_INVALID_PCP_TARGETFILES_OPTIONALDATA : ErrorHResult = ErrorHResult::from_constant(3222163985); // ERROR_PCW_INVALID_PCP_TARGETFILES_OPTIONALDATA
#[doc(hidden)] pub const PCW_INVALID_PCP_UPGRADEDFILES_OPTIONALDATA : ErrorHResult = ErrorHResult::from_constant(3222163986); // ERROR_PCW_INVALID_PCP_UPGRADEDFILES_OPTIONALDATA
#[doc(hidden)] pub const PCW_MISSING_PATCHMETADATA : ErrorHResult = ErrorHResult::from_constant(3222163987); // ERROR_PCW_MISSING_PATCHMETADATA
#[doc(hidden)] pub const PCW_IMAGE_PATH_NOT_EXIST : ErrorHResult = ErrorHResult::from_constant(3222163988); // ERROR_PCW_IMAGE_PATH_NOT_EXIST
#[doc(hidden)] pub const PCW_INVALID_RANGE_ELEMENT : ErrorHResult = ErrorHResult::from_constant(3222163989); // ERROR_PCW_INVALID_RANGE_ELEMENT
