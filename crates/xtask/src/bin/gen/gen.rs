...
pub fn codes(codes: &scan::Codes) {
    ...
    mmrbi::fs::write_if_modified_with("crates/winresult/src/errors.natvis", |nv|{
        ...
        writeln!(nv)?;
        writeln!(nv, r#"    <Type Name="winresult_types::hresult::FacilityHrMicrosoft">"#)?;
        {
            macro_rules! microsoft_hresult_facilities {($(
                #define $prefix:ident $f:ident $value:literal
            )*) => {{$(
        ...
        writeln!(nv)?;
        writeln!(nv, r#"    <Type Name="winresult_types::ntstatus::FacilityNtStatusMicrosoft">"#)?;
        {
            macro_rules! microsoft_ntstatus_facilities {($(
                #define $prefix:ident $f:ident $value:literal
            )*) => {{$(
...
pub fn readme() {
    let winresult_doc_intro_md = std::fs::read_to_string("crates/winresult/doc/intro.md"  ).expect("crates/winresult/doc/intro.md");
